...
come true 实现；成为现实`,category:"七下词汇"}];function tt(){return ue.filter(e=>e.subject==="yw"||e.subject==="en")}const qt={yw:[{id:"yw_daily_read",title:"阅读理解1篇",icon:"📖"},{id:"yw_daily_book",title:"推荐书目阅读",icon:"📚"}],en:[{id:"en_daily_news",title:"时文阅读",icon:"📰"},{id:"en_daily_read",title:"阅读理解1篇",icon:"📝",satAlt:"作文+听力",satIcon:"🎧"}]};function vs(e,t,n){return(qt[e]||[]).map(a=>{const i=n&&a.satAlt;return{id:i?a.id+"_sat":a.id,title:i?a.satAlt:a.title,icon:i&&a.satIcon||a.icon,isSatVariant:i,originalId:a.id}})}const st={sx:[{chapter:"第十三章 三角形",items:["13.1 三角形的概念","13.2 与三角形有关的线段","13.3 三角形的内角与外角"]},{chapter:"第十四章 全等三角形",items:["14.1 全等三角形及其性质","14.2 三角形全等的判定","14.3 角的平分线"]},{chapter:"第十五章 轴对称",items:["15.1 图形的轴对称","15.2 画轴对称的图形","15.3 等腰三角形"]},{chapter:"第十六章 整式的乘法",items:["16.1 幂的运算","16.2 整式的乘法","16.3 乘法公式"]},{chapter:"第十七章 因式分解",items:["17.1 用提公因式法分解因式","17.2 用公式法分解因式"]},{chapter:"第十八章 分式",items:["18.1 分式及其基本性质","18.2 分式的乘法与除法","18.3 分式的加法与减法","18.4 整数指数幂","18.5 分式方程"]}],wl:[{chapter:"第一章 机械运动",items:["1.1 长度和时间的测量","1.2 运动的描述","1.3 运动的快慢","1.4 测量平均速度"]},{chapter:"第二章 声现象",items:["2.1 声音的产生与传播","2.2 声音的特性","2.3 声的利用","2.4 噪声的危害和控制"]},{chapter:"第三章 物态变化",items:["3.1 温度","3.2 熔化和凝固","3.3 汽化和液化","3.4 升华和凝华"]},{chapter:"第四章 光现象",items:["4.1 光的直线传播","4.2 光的反射","4.3 平面镜成像","4.4 光的折射","4.5 光的色散"]},{chapter:"第五章 透镜及其应用",items:["5.1 透镜","5.2 生活中的透镜","5.3 凸透镜成像的规律","5.4 眼睛和眼镜","5.5 显微镜和望远镜"]},{chapter:"第六章 质量与密度",items:["6.1 质量","6.2 密度","6.3 测量物质的密度","6.4 密度与社会生活"]}]};function mt(e){if(!e)return null;if(e.startsWith("sp_"))return"sp";if(e.startsWith("ch_sx_"))return"sx";if(e.startsWith("ch_wl_"))return"wl";if(e.startsWith("sx_ch_"))return"sx";if(e.startsWith("wl_ch_"))return"wl";if(e.startsWith("ot_"))return"ot";if(e.startsWith("hw_"))return"hw";if(e.startsWith("daily_")){const t=e.split("_");if(t.length>=2){const n=t[1];if(n==="yw"||n==="en")return n}return"daily"}return null}function ys(e,t){let n=1;return e.subject==="yw"&&(n=1,e.content&&e.content.length>100&&(n=2)),e.subject==="en"&&(n=1,e.content&&e.content.length>200&&(n=2)),Qe(t)===6&&(n+=1),Math.min(n,O.maxStarsPerDay)}async function je(e,t,n={}){const s=ue.find(r=>r.id===e),a=n.subjectId||(s?s.subject:mt(e));if(!s&&!n.subjectId&&!mt(e))throw new Error(`Task not found: ${e}`);if(await Et(t,e))return{state:"unchanged",events:[]};const o=n.stars||(s?ys(s,t):1),v={date:t,subjectId:a,taskId:e,type:a,stars:o,timestamp:Date.now(),isBlindbox:n.isBlindbox||!1,isChallenge:n.isChallenge||!1,note:n.note||"",sportType:n.sportType||"",customTitle:n.customTitle||"",customContent:n.customContent||""};await ls(v);const l=["task_completed"],c={action:"completed",taskId:e,stars:o},d=await bs(t);return l.push(...d),{state:c,events:l}}async function Ee(e,t){const n=await Et(t,e);return n?(await us(t,e),{state:{action:"undone",taskId:e,stars:n.stars},events:["task_undone"]}):{state:"unchanged",events:[]}}async function hs(){const e=await de(),t=new Set(e.map(i=>i.date)),n=W();let s=0,a=n;for(;V(a);){if(I(a)||Q(a)){a=ce(a,-1);continue}if(t.has(a))s++,a=ce(a,-1);else break}return s}async function fs(){const e=await de(),t=[...new Set(e.map(i=>i.date))].sort();let n=0,s=0,a=null;for(const i of t){if(!a)s=1;else{ce(a,1);const o=jt(a,i);let v=!0,l=ce(a,1);for(;l<i;){if(!I(l)&&!Q(l)){v=!1;break}l=ce(l,1)}o===1||o>1&&v?s++:s=1}s>n&&(n=s),a=i}return n}async function pe(){const e=await de(),t=W(),n=e.filter(p=>p.date===t),s=n.reduce((p,y)=>p+y.stars,0),a=e.reduce((p,y)=>p+y.stars,0),i=e.length,o=[...new Set(e.map(p=>p.taskId))],v={};for(const p of le){const y=e.filter($=>$.subjectId===p.id),b=[...new Set(y.map($=>$.taskId))];let k=ue.filter($=>$.subject===p.id).length;k===0&&p.type==="chapter"&&(k=xs(p.id).length),v[p.id]={name:p.name,icon:p.icon,color:p.color,records:y.length,stars:y.reduce(($,S)=>$+S.stars,0),completedUnique:b.length,totalTasks:k,percentage:k>0?Math.round(b.length/k*100):0}}const l=await hs(),c=await fs(),d=[...new Set(e.map(p=>p.date))].length,r=tt(),f=r.filter(p=>o.includes(p.id)).length;return{todayStars:s,totalStars:a,totalRecords:i,activeDays:d,streak:l,maxStreak:c,completedTaskIds:o.length,reciteCompleted:f,reciteTotal:r.length,subjectStats:v,todayProgress:n}}const ms=[{id:"first_blood",title:"初次登场",desc:"完成第一次任务打卡",icon:"🕵",check:e=>e.totalRecords>=1},{id:"ten_tasks",title:"见习侦探",desc:"累计完成10次打卡",icon:"🔍",check:e=>e.totalRecords>=10},{id:"thirty_tasks",title:"初级探员",desc:"累计完成30次打卡",icon:"📋",check:e=>e.totalRecords>=30},{id:"fifty_tasks",title:"中级探员",desc:"累计完成50次打卡",icon:"💼",check:e=>e.totalRecords>=50},{id:"hundred_tasks",title:"高级探长",desc:"累计完成100次打卡",icon:"🏅",check:e=>e.totalRecords>=100},{id:"two_hundred",title:"重案组组长",desc:"累计完成200次打卡",icon:"💪",check:e=>e.totalRecords>=200},{id:"three_hundred",title:"警界之光",desc:"累计完成300次打卡",icon:"🌎",check:e=>e.totalRecords>=300},{id:"streak_3",title:"三日追踪",desc:"连续打卡3天",icon:"🔥",check:e=>e.streak>=3},{id:"streak_5",title:"五日搜证",desc:"连续打卡5天",icon:"🧐",check:e=>e.streak>=5},{id:"streak_7",title:"七日连环案",desc:"连续打卡7天",icon:"💿",check:e=>e.streak>=7},{id:"streak_14",title:"半月大追捕",desc:"连续打卡14天",icon:"🌍",check:e=>e.streak>=14},{id:"streak_21",title:"夏洛克之魂",desc:"连续打卡21天",icon:"🧥",check:e=>e.streak>=21},{id:"streak_30",title:"侦探之王",desc:"连续打卡30天",icon:"👑",check:e=>e.streak>=30},{id:"star_25",title:"证物碎片",desc:"累计获得25颗星星",icon:"⭐",check:e=>e.totalStars>=25},{id:"star_50",title:"铜星侦探",desc:"累计获得50颗星星",icon:"🥇",check:e=>e.totalStars>=50},{id:"star_100",title:"银星侦探",desc:"累计获得100颗星星",icon:"🥈",check:e=>e.totalStars>=100},{id:"star_200",title:"金星侦探",desc:"累计获得200颗星星",icon:"🥉",check:e=>e.totalStars>=200},{id:"star_350",title:"钻石侦探",desc:"累计获得350颗星星",icon:"💎",check:e=>e.totalStars>=350},{id:"star_500",title:"传奇侦探",desc:"累计获得500颗星星",icon:"🌟",check:e=>e.totalStars>=500},{id:"five_star_day",title:"重大发现",desc:"单日获得5颗以上星星",icon:"✨",check:e=>e.todayStars>=5},{id:"eight_star_day",title:"线索井喷",desc:"单日获得8颗以上星星",icon:"💥",check:e=>e.todayStars>=8},{id:"ten_star_day",title:"证据确凿",desc:"单日获得10颗以上星星",icon:"📦",check:e=>e.todayStars>=10},{id:"fifteen_star_day",title:"案发现场",desc:"单日获得15颗以上星星",icon:"🚨",check:e=>e.todayStars>=15},{id:"yw_half",title:"古籍研究员",desc:"完成50%的古籍破译任务",icon:"📖",check:e=>e.subjectStats.yw&&e.subjectStats.yw.percentage>=50},{id:"yw_master",title:"古籍破译大师",desc:"完成全部古籍破译任务",icon:"🏛",check:e=>e.subjectStats.yw&&e.subjectStats.yw.percentage>=100},{id:"en_half",title:"密码学见习",desc:"完成50%的密文翻译任务",icon:"📩",check:e=>e.subjectStats.en&&e.subjectStats.en.percentage>=50},{id:"en_master",title:"密码学专家",desc:"完成全部密文翻译任务",icon:"🔐",check:e=>e.subjectStats.en&&e.subjectStats.en.percentage>=100},{id:"sx_half",title:"逻辑分析",desc:"完成50%的数学章节",icon:"📐",check:e=>e.subjectStats.sx&&e.subjectStats.sx.percentage>=50},{id:"wl_half",title:"现场重建",desc:"完成50%的物理章节",icon:"🔬",check:e=>e.subjectStats.wl&&e.subjectStats.wl.percentage>=50},{id:"days_10",title:"十天足迹",desc:"累计活跃10天",icon:"📅",check:e=>e.activeDays>=10},{id:"days_20",title:"二十天行动",desc:"累计活跃20天",icon:"📆",check:e=>e.activeDays>=20},{id:"days_35",title:"全勤侦探",desc:"累计活跃35天",icon:"🏃",check:e=>e.activeDays>=35},{id:"days_45",title:"风雨无阻",desc:"累计活跃45天",icon:"☂",check:e=>e.activeDays>=45},{id:"first_poem",title:"古诗破译入门",desc:"完成任意一篇古诗背诵",icon:"🖋",check:e=>e.subjectStats.yw&&e.subjectStats.yw.records>=1},{id:"first_eng",title:"密电初解",desc:"完成任意一组英文单词背诵",icon:"📨",check:e=>e.subjectStats.en&&e.subjectStats.en.records>=1},{id:"weekend_warrior",title:"周末探员",desc:"周六打卡获得3颗以上星星",icon:"🎢",check:e=>e.todayStars>=3}];async function bs(e){const t=await pe(),n=await Le(),s=new Set(n.map(i=>i.id)),a=[];for(const i of ms)if(!s.has(i.id))try{i.check(t)&&(await ps({id:i.id,title:i.title,desc:i.desc,icon:i.icon,unlockedAt:e||W()}),a.push("achievement_unlocked"))}catch(o){console.error("Achievement check failed:",i.id,o)}return a}async function Mt(){const e=await pe(),{totalStars:t,totalRecords:n,streak:s,maxStreak:a}=e;if(n===0)return{level:0,title:"见习侦探",icon:"🕵",color:"#94A3B8",nextTitle:"初级侦探",nextNeed:1};const i=t+n*.5+a*2;return i<10?{level:1,title:"见习侦探",icon:"🕵",color:"#94A3B8",progress:i/10,nextTitle:"初级侦探",nextNeed:10}:i<25?{level:2,title:"初级侦探",icon:"🕵‍♂",color:"#22C55E",progress:(i-10)/15,nextTitle:"中级侦探",nextNeed:25}:i<50?{level:3,title:"中级侦探",icon:"🔍",color:"#3B82F6",progress:(i-25)/25,nextTitle:"高级侦探",nextNeed:50}:i<100?{level:4,title:"高级侦探",icon:"🧐",color:"#8B5CF6",progress:(i-50)/50,nextTitle:"名侦探",nextNeed:100}:i<200?{level:5,title:"名侦探",icon:"🏅",color:"#F59E0B",progress:(i-100)/100,nextTitle:"传奇侦探",nextNeed:200}:{level:6,title:"传奇侦探",icon:"👑",color:"#EF4444",progress:1,nextTitle:null,nextNeed:null}}async function gs(){const e=await de(),t=new Set(e.map(l=>l.taskId)),n=await et();for(const l of n)t.has(l.taskId)&&await ft(l.taskId,null);const a=tt().filter(l=>!t.has(l.id));if(a.length===0)return[];const i=[];let o=W();for(;o<=O.endDate;)!I(o)&&!Q(o)&&i.push(o),o=ce(o,1);if(i.length===0)return[];const v=[];a.forEach((l,c)=>{const d=Math.floor(c*i.length/a.length),r=i[Math.min(d,i.length-1)];v.push({taskId:l.id,suggestedDate:r})});for(const l of v)await ft(l.taskId,l.suggestedDate);return v}async function ws(){const e=await de(),t={};for(const a of e)t[a.date]||(t[a.date]={stars:0,count:0,tasks:[]}),t[a.date].stars+=a.stars,t[a.date].count++,t[a.date].tasks.push(a);const n=[];let s=O.startDate;for(;s<=O.endDate;){const a=t[s]||null;n.push({date:s,isSunday:I(s),isTravel:Q(s),isToday:s===W(),stars:a?a.stars:0,count:a?a.count:0,hasActivity:!!a}),s=ce(s,1)}return n}function ks(e,t){return(st[e]||[]).map((s,a)=>({chapterIndex:a,chapterTitle:s.chapter,items:s.items.map((i,o)=>({id:`ch_${e}_${a}_${o}`,title:i,subject:e,chapterIndex:a,itemIndex:o}))}))}function xs(e){const t=st[e]||[],n=[];return t.forEach((s,a)=>{s.items.forEach((i,o)=>{n.push({id:`ch_${e}_${a}_${o}`,title:i,subject:e,chapterIndex:a,itemIndex:o})})}),n}const nt=[{id:"c01",title:"失踪的暑假作业",desc:"暑假作业本离奇失踪，现场只留下一张神秘纸条",cluesNeeded:2,icon:"📝",clues:["作业本最后一页有半枚蓝色墨水指纹，指纹纹路较浅，像是孩子的手","同桌小明最近总是躲躲闪闪，他的铅笔盒里多了一支同样的蓝色钢笔"],question:"暑假作业最可能是谁拿走的？",options:["同桌小明想借作业抄","被家里的宠物狗叼到院子里了","自己做完后忘记放哪了"],answer:0,explanation:"蓝色墨水指纹和同桌小明包里的钢笔对上了！原来是小明偷偷拿走了作业本想抄，结果还没来得及还就被发现了。"},{id:"c02",title:"图书馆的午夜灯光",desc:"连续三晚，闭馆后的图书馆总有一盏灯亮着",cluesNeeded:2,icon:"📚",clues:["亮灯的位置是图书馆角落的自然科学区，桌上的书堆里夹着一张手绘的星图","管理员说最近总有一个戴眼镜的男生在闭馆铃响后磨磨蹭蹭不走"],question:"午夜灯光是谁留下的？",options:["管理员忘记关灯了","天文社的学长在偷偷研究星图","图书馆闹鬼了"],answer:1,explanation:"星图和戴眼镜的男生线索串起来了！天文社的学长为了准备天文竞赛，每晚躲在图书馆研究星图，他是从后窗翻进去的。"},{id:"c03",title:"食堂失窃案",desc:"食堂冰箱里的布丁不翼而飞，目击者称看到可疑黑影",cluesNeeded:2,icon:"🍦",clues:["冰箱把手上残留着面粉痕迹，旁边地上有几粒面包屑","食堂后门监控拍到一只橘猫叼着白色物体跑过"],question:"布丁到底去哪了？",options:["被面包房师傅拿去研究配方了","橘猫从没关好的冰箱里叼走了","值日生当垃圾扔掉了"],answer:1,explanation:"面粉痕迹是猫咪踩过面包房留下的脚印，而监控里橘猫叼走的白色物体正是布丁杯！这家伙已经是食堂惯犯了。"},{id:"c04",title:"神秘的信件",desc:"连续一周收到没有署名的信件，每封都写着不同的密码",cluesNeeded:3,icon:"✉",clues:["每封信的邮戳都是学校附近的邮局，寄出时间都在周三下午3点","密码破译后发现是摩斯电码，内容都是在描述一道数学题的不同解法","周三下午3点正是数学竞赛辅导班的课间休息时间"],question:"神秘信件是谁寄的？",options:["数学竞赛班的某个同学在偷偷传递答案","一个想交笔友的匿名同学","有人在恶作剧"],answer:0,explanation:"周三下午3点+邮戳+摩斯电码数学题——数学竞赛班的学霸在用这种酷炫的方式给暗恋的同学传纸条，结果被当成谜案了！"},{id:"c05",title:"实验室的异常声响",desc:"放学后的物理实验室传来奇怪的嗡嗡声",cluesNeeded:3,icon:"🔬",clues:["声音来源是一台被改装过的老式收音机，天线被加长了两倍","收音机旁有一本写满频率数字的笔记本，笔迹很工整",'笔记本最后一页写着"如果能收到空间站的信号就好了"'],question:"嗡嗡声是谁弄出来的？",options:["物理老师在测试新设备","某个学生想接收国际空间站的无线电信号","收音机坏了自己乱响"],answer:1,explanation:"长天线+频率笔记本+空间站愿望——一个无线电爱好者同学改装了收音机，每天放学后来实验室搜索来自太空的信号！"},{id:"c06",title:"消失的运动会奖牌",desc:"上届运动会的金牌在展柜中凭空消失",cluesNeeded:3,icon:"🏅",clues:["展柜玻璃没有被撬的痕迹，是用钥匙正常打开的","体育办公室的钥匙柜少了一把备用钥匙","上一届百米冠军李明最近情绪低落，他的金牌是他已故父亲唯一看过他得到的奖"],question:"奖牌为什么消失了？",options:["有贼偷走卖钱","李明自己拿去擦洗保养了","有人恶作剧藏起来了"],answer:1,explanation:"李明用自己偷偷配的备用钥匙取走了金牌，因为金牌上有一块污渍他想擦干净。他太珍视这枚奖牌了，所以想自己悄悄保养。"},{id:"c07",title:"教室里的涂鸦",desc:"周一早上发现黑板上画满了奇怪符号，值日生发誓昨晚擦干净了",cluesNeeded:3,icon:"🎨",clues:["符号全是古希腊字母，排列方式和星座图一模一样","黑板下方的粉笔槽里留着一根荧光粉笔，普通学生没有这种笔","美术社的活动记录显示，周末有人借用过美术教室"],question:"谁在黑板上画了这些符号？",options:["想用星座图给班上同学惊喜的美术社成员","外星人真的来过","数学老师准备的课前谜题"],answer:0,explanation:"美术社成员周末借了美术教室，用社团的荧光粉笔画了这幅星座图，想给周一来上课的同学们一个惊喜——他们班下周正学天文学。"},{id:"c08",title:"校长室的访客",desc:"监控拍到深夜有人进入校长室，但第二天什么都没少",cluesNeeded:3,icon:"🚪",clues:["校长室门口的盆栽被挪动过位置，花盆底下藏着一把老式钥匙","校长办公桌上多了一份没有署名的建议书，字迹有些歪歪扭扭","建议书的内容是关于改善学校午餐质量的，还画了很多可爱的小插图"],question:"深夜访客是谁？",options:["有贼踩点但没找到值钱东西","一个害羞的学生趁夜递交午餐改善建议","副校长加班忘记关门了"],answer:1,explanation:"一个太害羞不敢当面说话的学生，鼓起勇气趁夜把建议书放到了校长桌上。那把钥匙是他用零花钱从老教师那求来的旧钥匙。"},{id:"c09",title:"诡异的天气预报",desc:"有人提前一周准确预测了每天的天气，甚至精确到分钟",cluesNeeded:3,icon:"⛈",clues:["预测者使用的数据来源全部是公开气象网站的数据",'预测者的草稿纸上画满了复杂的统计图表，封面上写着"2026年初中数学建模大赛"',"气象局的数据恰好验证：这一周没有异常天气，非常规律，模型预测成功率本来就在70%以上"],question:"天气预报是怎么做到的？",options:["有人有未卜先知的超能力","一个参加数学建模比赛的同学做的科学预测","纯粹是巧合猜中了"],answer:1,explanation:"这不是超能力，而是一个参加数学建模大赛的同学，用回归分析和概率模型做了一个天气预测系统，恰好这周天气规律，被他算准了！"},{id:"c10",title:"垃圾桶里的密码本",desc:"在垃圾桶发现一本写满密码的笔记本，似乎隐藏着重大秘密",cluesNeeded:4,icon:"📓",clues:["密码破译第一层后是凯撒密码，内容是一串看似杂乱的人名和日期","每个人名都是学校文学社的成员，日期恰好是他们发表作品的日期",'继续破译，发现那些"日期"其实是图书编号',"按编号在图书馆找到对应的书，每本书里都夹着一篇社员的获奖作文"],question:"这本密码本是谁的？",options:["间谍在学校秘密传递情报","文学社社长用密码记录社团的优秀作品","有人在设计密室逃脱游戏"],answer:1,explanation:'文学社社长用密码本记录社团所有获奖作品的位置，这样就算被偷看也不会泄露社团的"宝藏"。这位社长将来肯定是个好侦探！'},{id:"c11",title:"田径场的地下通道",desc:"田径场跑道下方发现了一条不为人知的通道",cluesNeeded:4,icon:"🏃",clues:["通道墙壁上有1950年代的老式电灯开关，还能用","通道尽头是一个干燥的小房间，里面有旧课桌和黑板",'黑板上写着一行字："1968届初三(2)班防空洞纪念"',"翻阅校史，1968年学校确实有过一个地下防空洞项目"],question:"这个地下通道是什么？",options:["坏人的秘密基地","上世纪60年代修建的防空洞","施工队留下的废弃管道"],answer:1,explanation:"这是上世纪60年代全校师生一起挖的防空洞！当时的初三(2)班在这个小房间里上过课，黑板上的字就是他们毕业时留下的纪念。"},{id:"c12",title:"音乐教室的幽灵钢琴",desc:"半夜路过音乐教室的人都说听到了钢琴声，但琴凳上没人",cluesNeeded:4,icon:"🎹",clues:["钢琴是一台带自动演奏功能的电钢琴，型号是Yamaha Clavinova","音乐老师最近请了病假，走之前忘了关掉自动演奏的定时播放功能","定时播放设置的是每天晚上8点，播放的是肖邦的《夜曲》","调查云端的教学记录，音乐老师原计划用这首曲子帮同学们放松心情"],question:"幽灵钢琴的真相是什么？",options:["真的闹鬼了","音乐老师的电钢琴定时播放没关","有人在恶作剧"],answer:1,explanation:"音乐老师本想每天晚自习后给同学们放音乐放松，结果忘记关了，每晚8点自动播放《夜曲》。没有幽灵，只有一位好心的音乐老师！"},{id:"c13",title:"花坛里的神秘植物",desc:"校园花坛里长出了一株从没见过的植物，生长速度快得惊人",cluesNeeded:4,icon:"🌿",clues:["植物叶片形状和普通豆芽相似，但茎干上有一层绒毛","花坛土壤检测出高浓度有机肥料，是市面上买不到的发酵配方","生物社实验记录显示，他们在测试一种新的有机催芽液","催芽液的原料包括咖啡渣、蛋壳粉和糖蜜，按特殊比例发酵一周"],question:"这株神秘植物是怎么来的？",options:["外星植物入侵地球","生物社的实验催芽液让普通豆子疯长","有学生从亚马逊带回来的"],answer:1,explanation:'生物社的同学用自制的咖啡渣催芽液浇灌了一颗普通豆子，结果生长速度惊人！这就是科学的力量——虽然实验记录最后写着"配方需进一步优化"。'},{id:"c14",title:"食堂阿姨的秘密菜单",desc:"食堂阿姨总是在特定时间端出一份谁都没见过的菜",cluesNeeded:4,icon:"🍲",clues:["这道菜只在周二中午和周四下午出现，每次都放在最左边的窗口","菜的味道每周都在微调，甜度、辣度有细微变化",'食堂阿姨的笔记本里夹着一张泛黄的菜谱，上面写着"妈妈的糖醋排骨——实验版"',"阿姨的女儿在外地上大学，最大的遗憾是没教会女儿做这道家传菜"],question:"秘密菜单的真相是什么？",options:["食堂在研究新菜品",'阿姨在用同学们当"试吃员"完善家传菜谱',"这是给老师开的小灶"],answer:1,explanation:"食堂阿姨的女儿最爱吃妈妈做的糖醋排骨，但上大学前没学会。阿姨决定把菜谱标准化，用同学们的反馈来调出最佳配方，好教给远方的女儿。"},{id:"c15",title:"天文台的信号",desc:"学校天文台的设备接收到了一组规律性的无线电信号",cluesNeeded:4,icon:"🔭",clues:["信号的频率是1420MHz，恰好是宇宙中氢原子的特征频率（SETI项目常用频段）","信号每隔7分23秒重复一次，内容是一个递增的数字序列：1, 1, 2, 3, 5, 8, 13...","这个序列是斐波那契数列——地球上最基础的自然数列之一","进一步分析发现，信号源方向正好对着3公里外市电视台的信号塔"],question:"这组信号真的是外星人发的吗？",options:["外星人在联系我们","市电视台在测试新设备时意外产生了干扰信号","同学做的科学恶作剧"],answer:1,explanation:"市电视台新装了数字信号发射器，在测试时意外产生了一个谐波落在1420MHz频段上。斐波那契数列恰好是测试工程师最喜欢的基准测试模式之一！"},{id:"c16",title:"消失的校史",desc:"校史馆中关于建校前20年的记录全部消失了",cluesNeeded:4,icon:"🏛",clues:["校史馆的档案编号有缺失，跳过了D-001到D-020整整20盒","老教师王老师回忆，学校建于1958年，但官方记录从1978年才开始",'1978年之前的资料都盖着"已移交市教育局档案室"的章',"联系教育局确认，这批档案因年代久远，三年前被借去数字化扫描，还没归还"],question:"消失的校史去哪了？",options:["有人故意销毁历史记录","档案被借去数字化扫描还没还回来","那20年根本不存在"],answer:1,explanation:"不是阴谋，是教育局三年前借走做数字化扫描，因为项目排队排到现在还没扫描完。那20年的校史正安静地躺在教育局的档案室里呢！"},{id:"c17",title:"双胞胎的互换日记",desc:"一对双胞胎举报对方的日记被调包，两人都声称自己才是真的",cluesNeeded:4,icon:"📔",clues:["两本日记封面完全相同，都是蓝色硬壳本，购自同一家文具店",'姐姐的日记里频繁出现"数学考试"的焦虑，妹妹的日记则充满了篮球比赛的兴奋',"调包当天正好是期中成绩公布的日子",'后来发现姐姐数学其实考了全班第三，她在日记里写的是"比妹妹考得好"的开心'],question:"日记被调包了吗？",options:["有人恶作剧调换了她们的本子","两人自己拿错了，因为封面一模一样","她们故意换着写的"],answer:1,explanation:'其实根本没被调包！两人买了一模一样的本子，期中那天都太紧张拿错了对方桌上的。姐姐那本"数学焦虑"是之前写的，考得好之后早就换心情了。'},{id:"c18",title:"后山的石碑密码",desc:"后山发现一块刻满古文字的石碑，似乎指向某个隐藏地点",cluesNeeded:5,icon:"🗿",clues:["石碑上的文字经鉴定是小篆体，内容是李白的《静夜思》","每句诗的第一个字被刻意刻得更深：床、疑、举、低","按笔画数转换：床(7画)、疑(14画)、举(9画)、低(7画)——得到一个四位数","这个数字是学校老教学楼一楼的教室编号走廊，7149教室早就不在了","实地探访发现，7149的位置现在是图书馆的一个小隔间，里面藏着一个2000届毕业生的时光胶囊"],question:"石碑密码指向什么？",options:["古代人留下的藏宝图","2000届校友埋下的时光胶囊","有人在设计寻宝游戏"],answer:1,explanation:'2000届毕业生在离校前埋了一个时光胶囊，用石碑密码留给后人这个线索。胶囊里有2000年的校服、饭票、手写同学录，还有一封信写着"希望25年后有人找到它"。'},{id:"c19",title:"机房里的黑客",desc:"学校官网被篡改，首页变成了一张藏宝图",cluesNeeded:5,icon:"💻",clues:["藏宝图标注的地点全是校园里的真实位置：喷泉、梧桐树、老钟楼","网站后台日志显示，篡改来自校内IP，时间是周六下午3点","这不是恶意攻击——原网站内容被完整备份到了/admin/backup目录下",'藏宝图底部有一行小字："信息课课代表和他的朋友们"','按藏宝图的路线走，每个点都藏着一张卡片，集齐拼出："欢迎新生"'],question:'"黑客"是谁？',options:["外网骇客攻击学校","信息课代表用学校官网给新生准备的欢迎惊喜","系统bug导致的错误"],answer:1,explanation:"信息课代表想给即将入学的新生一个特别的欢迎仪式。他完整备份了原网站，然后把首页改成了互动藏宝图——技术好又会设计，学校捡到宝了！"},{id:"c20",title:"游泳馆的水怪",desc:"多名学生声称在游泳馆看到了不明生物",cluesNeeded:5,icon:"🏊",clues:["所有目击报告都发生在周四下午4点到5点之间",'"水怪"被描述为黑色、细长、大约1.5米、在水中快速游动',"游泳馆的排水口滤网最近被拆走了，物业说送去维修","周四下午4点正是游泳队训练时间，队里有一个常年穿黑色长泳裤的队员","该队员擅长蝶泳，游动时双腿并拢打水，从水下看确实像一条黑色带子"],question:"水怪的真相是什么？",options:["真的有不明水生物","游泳队员的黑泳裤+蝶泳动作在远处看像水怪","有人放了条大黑鱼"],answer:1,explanation:"游泳队的蝶泳健将在训练时，他的黑色长泳裤在池底光影折射下，加上蝶泳的波浪式游动，远远看去就像一条游动的水怪！排水口滤网被拆也让池水有些浑浊助长了错觉。"},{id:"c21",title:"美术室的画中人",desc:"美术室一幅人物肖像的表情似乎在每天变化",cluesNeeded:5,icon:"🖼",clues:["画作是一个女生的侧脸，技法上用了渐变的暖色调","每天早上8点到9点，阳光恰好从东窗照进来，落在画的右侧","9点以后阳光消失，画作回到正常状态","不同光照角度下，暖色调中的微妙阴影会产生不同的视觉感受",'美术老师在画作背面贴了张纸条："试试早上看，会有惊喜"'],question:"画中人的表情为什么会变化？",options:["画活了过来","阳光角度变化造成的光影错觉","有人每天偷偷在改画"],answer:1,explanation:"美术老师巧妙地利用了东方窗户的光照。早上8-9点阳光从特定角度照射时，暖色调中的阴影渲染会让嘴角看起来微微上扬——一幅会用光的杰作！"},{id:"c22",title:"宿管阿姨的猫",desc:"宿管阿姨的猫叼回了一只带有血迹的徽章",cluesNeeded:5,icon:"🐈",clues:['徽章是铜质的，上面刻着"SHS 1988"，血迹经检测不是人血','"SHS"是学校英文名的缩写，1988年正是学校建校30周年',"猫咪平时活动的范围在校园后山，那里有一片老旧的教师宿舍区","血迹检测结果是鸡血——后山有退休老教师在院子里养了几只鸡","1988届校友通讯录显示，一位退休的物理老师住在后山，正是那栋养鸡的房子"],question:"徽章和猫的故事是什么？",options:["发生了一起严重案件","猫从退休老教师院子叼走了他珍藏的校庆纪念徽章","徽章是假的，血是番茄酱"],answer:1,explanation:"猫咪溜进退休物理老师家的院子，在鸡窝旁叼走了老师珍藏的1988年校庆纪念徽章。鸡血是碰巧蹭上的。老师还以为徽章弄丢了，难过了好几天。"},{id:"c23",title:"考古社的惊天发现",desc:"考古社在校园角落挖出了一件疑似文物的东西",cluesNeeded:5,icon:"⛏",clues:["出土物品是一个陶罐，表面有简单的几何纹样","经学校历史老师初步判断，纹样风格属于汉代","学校校址在汉代确实是一个小型聚落的边缘地带","送去市博物馆做碳14检测","检测结果：这个陶罐制作于——2003年。底部有极小的模具编号：2003-AT-047。原来是一个现代仿古陶罐"],question:'这个"文物"的真相是什么？',options:["发现了汉代遗址","2003年一个陶艺兴趣班留下的仿古作品","有人故意埋的假文物"],answer:1,explanation:'2003年学校办过一个陶艺兴趣班，老师让同学们模仿汉代风格做陶罐。一个同学做得太逼真，后来被埋在了花坛里做"时间胶囊"。20多年后，考古社挖出来以为是真文物！'},{id:"c24",title:"广播站的加密广播",desc:"午间广播中夹杂着一段加密语音，只有特定设备能解码",cluesNeeded:5,icon:"📢",clues:["加密语音的频谱分析显示，信号被调制在18kHz以上的高频段，人耳听不到",'解码后发现内容是："放学后天台见——x"','广播站设备上贴了一张手写便利贴："勿调18k频段，测试中"','广播站站长最近在捣鼓一个"超声波传信"项目',"超声波通信原理：把声音信号调制到20kHz附近，可以被手机APP解码"],question:"加密广播是什么？",options:["间谍在传递情报","广播站站长在测试超声波通信","设备坏了产生杂音"],answer:1,explanation:'广播站站长是个技术宅，他在测试超声波通信——把人声编码到高频段，只有装有解码APP的同学能听到。那句"天台见"是在约副站长开会。'},{id:"c25",title:"屋顶的无人机",desc:"一架不明无人机每晚准时悬停在教学楼屋顶",cluesNeeded:5,icon:"🛩",clues:["无人机型号是DJI Mini 3，挂载了一台GoPro相机","每晚悬停时间恰好8分钟，然后自动返航","无人机降落在距离学校2公里的一个居民小区阳台上","找到了机主：一个初二男生，他的房间贴满了城市夜景照片",'他每天用无人机拍屋顶落日，准备做一本"城市之巅"摄影集参赛'],question:"无人机为什么每晚悬停在教学楼？",options:["有人在偷拍学校","一个同学用无人机拍摄夕阳城市风光","无人机失控了"],answer:1,explanation:'这位同学发现教学楼屋顶是拍摄城市夕阳的最佳角度，每晚用无人机定点拍摄8分钟。他的摄影集"城市之巅——屋顶看世界"已经入选了市青少年摄影大赛！'},{id:"c26",title:"化学老师的隐退",desc:"最受欢迎的化学老师突然请假，学生们决定找出真相",cluesNeeded:5,icon:"🧪",clues:['请假条上只写了"个人原因"，但办公桌上有一本翻开的《有机合成进阶》','老师的实验日志停在上周五，最后一页写着"样品送到市检科院"',"有同学在市区偶遇化学老师，她背着一个大包走进了科技馆",'科技馆正在布展"小小科学家"展览，展期覆盖整个暑假','科技馆的展讯海报上写着："特别感谢：各参赛学校化学教师团队"'],question:"化学老师为什么请假？",options:["老师生病了","老师去做科技馆青少年化学展的评委和指导","老师辞职了"],answer:1,explanation:'化学老师被请去科技馆做"小小科学家"化学展的指导老师，负责评审和布展指导。她想给大家一个惊喜——因为班上好几个同学的作品入选了！'},{id:"c27",title:"大钟楼的时间谜题",desc:"校园钟楼的指针开始倒着走，每次指向午夜都会有怪事发生",cluesNeeded:5,icon:"🕐",clues:["钟楼的机芯最后一次维护记录是在三周前",'维修师傅在维护日志中写道："顺便加了倒走功能——日常备用测试——下月回来校准"','"怪事"其实是学校在办一个夜间天文观测活动，每次都在午夜开始','天文社的活动海报上写着"钟声敲响时，望远镜对准天空"',"活动完全正常——只是钟倒着走的时间恰好和观星活动的开始时间重合了"],question:"钟楼时间谜题的真相是？",options:["时光倒流了","维修师傅测试倒走功能+天文社午夜观星活动的巧合","有人在搞破坏"],answer:1,explanation:"维修师傅为了测试钟的逆向功能临时设了倒走，还没来得及调回来。天文社恰好在那几晚办午夜观星活动——钟声是他们的开始信号。两件无关的事同时发生创造了都市传说！"},{id:"c28",title:"围墙外的涂鸦艺术家",desc:"围墙上每晚出现新的涂鸦，但监控里看不到任何人",cluesNeeded:5,icon:"🎨",clues:['涂鸦内容每天不同：周一"考试加油"、周二"别迟到"、周三画了一只猫',"所有涂鸦的高度都在2米左右，监控死角恰好在那一段围墙","涂鸦用的颜料是一种特制夜光漆，白天几乎看不见，晚上发光","夜光漆可以在美术用品店买到，记录显示一个月前有人买过5罐","购买人是上一届的毕业生，他考上美术学院后就一直想给母校留点东西"],question:"涂鸦艺术家是谁？",options:["不知名的街头艺术家","考上美术学院的校友在给母校留夜光祝福","调皮的小学生在乱画"],answer:1,explanation:"一位刚考上美术学院的校友，想用自己能做的方式给母校和学弟学妹们留下祝福。他研究好监控死角，用夜光漆在围墙上画了每天的鼓励语——白天低调，晚上发光。"},{id:"c29",title:"食堂的数学密码",desc:"食堂菜单价格里隐藏着一道数学谜题，解开的人可以获得免单",cluesNeeded:5,icon:"🧮",clues:["价格标签上的数字都是质数：鸡腿饭17元、牛肉面13元、炒青菜7元","如果把价格按菜名首字母排序：C7、J17、N13，连起来就是7-17-13",'7、17、13这三个数字恰好是最小的三个"幸运质数对"',"把三个数字相加：7+17+13=37，食堂的收银台编号正是37号","食堂经理说：只有发现这个规律并主动报出来的同学能得到免单"],question:"免单密码是什么？",options:["说出三个质数的和37",'喊"老板免单"',"背诵一串随机数字"],answer:0,explanation:'食堂经理是个数学爱好者，用这个好玩的密码给爱思考的同学发福利。只要告诉收银台"7+17+13=37"，今天的午餐就免单啦！'},{id:"c30",title:"传说中的第七栋楼",desc:"校园地图上标注了六栋教学楼，但所有老生都说还有第七栋",cluesNeeded:6,icon:"🏢",clues:["校园规划图上确实只有6栋教学楼：A到F","但老地图（1958年建校版）上还有一栋标注为G的建筑，后来被划掉了","G楼的位置现在是操场东边的一片小树林","那片小树林里有几块水泥地基的残骸，说明确实建过楼","校史记录：G楼是一座两层的临时板房，1965年建成，2000年拆除，因为它只是过渡建筑","所有在2000年前入学的校友，记忆中都有一栋G楼——它是当年的实验楼"],question:"第七栋楼的真相是什么？",options:["平行世界的大楼","2000年拆除的临时实验楼G楼，只有老校友记得","那个位置从来没建过楼"],answer:1,explanation:"G楼是1965年为缓解教室紧张而建的临时两层实验楼。2000年新实验楼建成后，G楼完成了历史使命被拆除，原址变成了小树林。它不是传说，它只是退休了。"},{id:"c31",title:"生物角的变色龙",desc:"班里生物角养的变色龙，每天早上颜色都不一样",cluesNeeded:3,icon:"🦎",clues:["变色龙旁边的温度计显示，每晚教室的温度都会降到20度以下","变色龙在低温时会自然变成深色，这是它的正常生理反应","值日生每天放学都会把空调定时设到凌晨4点自动关，教室后半夜会变冷"],question:"变色龙为什么每天变色？",options:["它生病了","教室后半夜降温，变色龙的自然反应","有人在晚上偷偷换了一只"],answer:1,explanation:"变色龙在温度低时会变深色来吸收更多热量。教室空调凌晨关掉后温度下降，它自然变色。早上大家进教室开空调后温度回升，它又变回来。"},{id:"c32",title:"自习室的敲击声",desc:"每天晚自习第二节，总能听到有规律的敲击声",cluesNeeded:3,icon:"💢",clues:['声音来自最后一排靠窗的位置，节奏是"哒-哒哒-哒-哒-哒哒"',"那个座位上坐的是一个正在准备编程竞赛的男生","他在桌面上用手指敲的是莫尔斯电码练习——他比赛里要用到"],question:"敲击声是什么？",options:["桌腿松了","同学在练习莫尔斯电码","有人在偷偷发暗号"],answer:1,explanation:'编程竞赛有一项是莫尔斯电码解码，这位同学在利用自习时间练习指法。节奏"哒-哒哒"就是摩斯电码中最基本的点划节奏。'},{id:"c33",title:"食堂菜单预言家",desc:"有人在校园论坛上每周五精准预言下周食堂菜单，从不失手",cluesNeeded:4,icon:"📅",clues:["预言帖总是在周五下午4点发布，比食堂公布时间早3天","食堂经理的电脑没有入侵痕迹，菜单文件也没有外泄","预言帖的语言风格轻松幽默，经常带颜文字和括号吐槽","食堂经理的女儿恰好在这个学校读初三，她的写作风格和预言帖一模一样"],question:"菜单预言家是谁？",options:["食堂经理自己发的","经理女儿偷看了爸爸的菜单草稿提前发出来","有黑客入侵"],answer:1,explanation:'食堂经理在家写菜单时被女儿看到，她觉得提前"剧透"很好玩，就开了个匿名账号每周提前发布。经理其实早就发现了，觉得女儿写得比自己公布的好玩，就装作不知道。'},{id:"c34",title:"更衣室的神秘香水",desc:"体育课后，女生更衣室里总有一股淡淡的茉莉花香",cluesNeeded:3,icon:"🌸",clues:["香味只在每周三和周五的体育课后出现","周三和周五的体育课，田径队和舞蹈队共用更衣室","舞蹈队的一个队员习惯在训练前往手腕上涂茉莉花味的护手霜——是她奶奶送她的生日礼物"],question:"香味从哪来的？",options:["学校放了空气清新剂","舞蹈队队员的茉莉花护手霜","外面飘进来的花香"],answer:1,explanation:"舞蹈队队员用的是奶奶送的茉莉花护手霜，训练前涂在手腕上，体育课换衣服时香味留在更衣室。只有周三和周五有，因为这两天舞蹈队和普通体育课共用更衣室。"},{id:"c35",title:"自动售货机的幽灵",desc:"教学楼自动售货机里的饮料，每天早上都少一瓶",cluesNeeded:3,icon:"🗱",clues:["售货机的交易记录里没有缺失饮料的扣款记录","机器没有撬痕，但投币口下方有一根细小的发卡碎片","管理员翻看监控，发现凌晨5点有一只流浪猫从机器背后的维修口钻了进去——维修口的盖子松了"],question:"饮料是谁拿的？",options:["有学生偷饮料","流浪猫钻进了售货机碰掉了一瓶","管理员自己喝了"],answer:1,explanation:'售货机背后的维修口盖子松了，凌晨时一只流浪猫钻进去取暖，不小心碰掉了一瓶饮料。饮料滚到取物口外面，猫出不来又出不来。每天早上管理员开门放它出去，它已经成了售货机的"深夜租客"。'},{id:"c36",title:"旗杆上的风筝",desc:"周一早上升旗时，发现旗杆顶上挂着一只红色风筝",cluesNeeded:3,icon:"🪁",clues:['风筝线上系着一张纸条，写着"对不起，我不是故意的——小风"',"上周日有校外人员来学校操场放风筝，保安有登记记录",'"小风"是一个8岁小男孩的昵称，他爸爸是学校的体育老师，周日带他来学校玩'],question:"风筝是谁的？",options:["不知谁恶作剧","体育老师的儿子放风筝时不慎挂上去的","风筝自己飞上去的"],answer:1,explanation:'体育老师周日带儿子来学校操场玩，儿子放风筝时线断了，风筝挂到了旗杆顶上。小家伙吓坏了，写了道歉纸条系在风筝线上，希望"升旗的叔叔"能看到。'},{id:"c37",title:"计算机教室的入侵者",desc:"计算机教室的鼠标和键盘每周都被重新排列过",cluesNeeded:4,icon:"🖥",clues:["所有设备被摆放成完全对称的格局，每排每列间距精确到毫米","监控显示每周四晚上8点有人进入计算机教室","进入的人穿着校服，走路的姿势一板一眼，进出都会把门把手擦干净","这个学生是计算机课代表，但他有轻微的强迫症——每次上完课看到设备不整齐就难受"],question:"谁在排列设备？",options:["清洁工不小心弄乱的","有强迫症的计算机课代表每周四来整理","恶作剧学生"],answer:1,explanation:'课代表有轻微的整理强迫症，看到设备不整齐就睡不好。他用计算机教室的钥匙每周四晚自习后来摆正所有设备，擦干净门把手。老师后来给他配了把新钥匙，专门表扬他"责任心强"。'},{id:"c38",title:"体育器材室的深夜灯光",desc:"保安巡逻时发现体育器材室凌晨还亮着灯，但门锁着",cluesNeeded:3,icon:"💡",clues:["器材室的管理员说每晚都关了灯才走","灯的开关附近有一个篮球架，篮球滚落时偶尔会碰到开关","器材室里有几只老鼠，每天夜里在篮球架上跑动，恰好会碰开灯"],question:"灯为什么会亮？",options:["管理员忘记关灯","老鼠在篮球架上跑动碰到了开关","有人在里面"],answer:1,explanation:"器材室的老鼠每天夜里在篮球架上跑动，篮球晃动碰到墙壁上的灯开关。这个开关位置装得比较低，刚好在篮球滚动轨迹的末端。管理员后来把开关加了个防护罩就解决了。"},{id:"c39",title:"值周生的秘密",desc:"每周五的值周总结本上，总会出现一行陌生的字迹",cluesNeeded:4,icon:"📓",clues:["字迹用铅笔写的，笔画圆润，和全班同学的字迹都对不上",'内容每次都是鼓励的话，比如"今天大家都表现很好"、"走廊很干净"',"这行字总是出现在值周生写完总结离开之后","班主任承认是她写的——她每次等大家都走了，回教室悄悄加一行鼓励"],question:"神秘字迹是谁的？",options:["隔壁班的恶作剧","班主任等大家走后悄悄加的鼓励","有同学偷偷回来写的"],answer:1,explanation:"班主任觉得值周总结太冷冰冰了，每次等值周生写完离开后回教室，用铅笔加一句暖心的鼓励。她故意用铅笔而不是红笔，就是不想让学生发现是老师写的。"},{id:"c40",title:"丢失的班费",desc:"收齐的班费在班长课桌里放了一晚后不翼而飞",cluesNeeded:4,icon:"💰",clues:["班长发誓把钱锁在了课桌里，但第二天早上锁是开着的","课桌的锁完好无损，说明是用钥匙打开的","班长的课桌钥匙只有两把——他自己一把，班主任保管备用钥匙","班主任前一天晚上接到教务处紧急通知，来教室取了班费去交——忘了告诉班长"],question:"班费去哪了？",options:["有小偷偷走了","班主任用备用钥匙取走去交费了，忘了通知班长","班长自己弄丢了"],answer:1,explanation:"教务处临时通知提前交费，班主任用备用钥匙取了班费去交，想着第二天告诉班长。结果第二天一早班长就发现钱没了，全班炸锅，班主任才一拍脑门想起来。"},{id:"c41",title:"图书馆的乱架书",desc:"图书馆的小说区每天都被翻得乱七八糟，但借阅记录里没人借过",cluesNeeded:3,icon:"📚",clues:["被翻乱的都是同一排书架——东野圭吾和阿加莎·克里斯蒂的全部作品","书没有被偷，只是顺序被打乱，有的还夹着饼干屑","图书馆管理员调取监控发现，每天午休时间一只橘猫从窗户溜进来，跳上书架睡觉——它恰好最喜欢悬疑小说区的位置"],question:"谁弄乱了书架？",options:["学生偷偷看了没借","橘猫每天来悬疑小说区睡午觉","管理员整理不够勤快"],answer:1,explanation:"图书馆的橘猫每天都从窗户进来，跳到最暖和的小说区书架上睡午觉。翻来翻去找舒服位置时把书弄乱了。饼干屑是它从食堂顺来的零食。这只猫还是个悬疑小说爱好者——至少它选的区域品味不错。"},{id:"c42",title:"自行车棚的连锁反应",desc:"放学时发现一排骨牌效应——12辆自行车全部倒了",cluesNeeded:3,icon:"🚲",clues:["倒下的顺序是从最东边开始，一辆接一辆向西倒","最东边那辆车的车筐里有一个篮球","篮球的主人上体育课时把球随手放在车筐里，风吹动篮球滚出来撞倒了第一辆车"],question:"自行车为什么全倒了？",options:["有人故意推倒的","篮球从车筐滚落撞倒第一辆，引发连锁反应","大风刮倒的"],answer:1,explanation:"最东边车筐里的篮球被风吹落，滚出来撞倒了旁边的车。这辆车倒了又撞倒下一辆，就像多米诺骨牌一样12辆车全倒了。物理课刚学完力学，这简直是活教材。"},{id:"c43",title:"花名册上的幽灵学生",desc:"教务系统的花名册上多了一个不存在的学生",cluesNeeded:4,icon:"👥",clues:['这个"学生"的名字叫"张新来"，学号是空的，所有科目都没有成绩','"张新来"只在系统里存在了三天就被删除了',"教务处说那三天正好在测试新教务系统的数据导入功能",'"张新来"是技术员随手打的测试数据——他的真名叫张新来，是软件开发公司的程序员'],question:"幽灵学生是怎么回事？",options:["系统bug","软件公司的程序员用自己名字做了测试数据","真有这个学生但转学了"],answer:1,explanation:'新教务系统上线前需要测试数据导入功能，程序员随手打了自己的名字"张新来"作为测试数据。测试完成后忘记清理，三天后才被教务老师发现并删除。程序员本人听说后笑了半天。'},{id:"c44",title:"课桌里的时间胶囊",desc:"一张旧课桌抽屉底部发现了一个密封的铁盒",cluesNeeded:4,icon:"📦",clues:['铁盒上刻着"2019届初三(5)班 十年后打开"','铁盒里有一封手写信、一张全班合影和一张2029年的"未来预测表"','预测表上写着："2029年我们班肯定有人当上了医生"——正好对应今年毕业的医学院学生名单',"照片里站在最后一排的男生，现在刚好回母校当实习老师"],question:"铁盒的意义是什么？",options:["有人恶作剧放的","2019届学生埋的时间胶囊，约定十年后回来打开","不小心掉进去的旧物"],answer:1,explanation:"2019届初三(5)班在毕业前埋了一个时间胶囊，约定2029年回母校一起打开。今年正好是2029年！当年的实习老师就是照片里的学生，他回来履行这个约定。"},{id:"c45",title:"操场上的粉笔线",desc:"每个周一早上，操场上都有一条新的彩色粉笔线",cluesNeeded:3,icon:"🏃",clues:["粉笔线从教学楼门口画到操场，拐了好几个弯","每个拐弯处都画了一个箭头和一个科目的图标：数学、语文、英语...",'体育老师承认是他画的——他用这种方式给初一新生做"校园定向越野"，让他们在找路中熟悉校园'],question:"粉笔线是谁画的？",options:["学生在恶作剧","体育老师设计的新生定向越野路线","施工队留下的标记"],answer:1,explanation:"体育老师设计了趣味定向越野，用粉笔线引导初一新生跑遍校园的每个角落。每个箭头标记了不同学科相关的校园地点——数学对应图书馆，英语对应语音教室，比发地图有意思多了。"},{id:"c46",title:"鼓号队的失踪乐器",desc:"鼓号队排练前发现小号少了一把",cluesNeeded:3,icon:"🎺",clues:["乐器室的锁是好的，其他乐器一件不少",'小号手李明上周说自己那把号"声音不对"，想换一把',"后来发现李明的小号在音乐老师办公室里——老师帮李明拿去清洗和调音了，忘了告诉他"],question:"小号去哪了？",options:["有人偷了","音乐老师拿去清洗调音忘了告诉学生","李明自己藏起来了"],answer:1,explanation:'李明跟音乐老师反映号声不对，老师就把小号拿回办公室清洗调音。忙起来忘了跟李明说，第二天排练时大家都在找"失踪"的小号。'},{id:"c47",title:"饮水机旁的排队之谜",desc:"总有同学在饮水机旁排队，但走近看水是满的",cluesNeeded:3,icon:"💧",clues:["排队的人手里都拿着空杯子，但就是不接水","排队的人都往饮水机上方的布告栏看，上面贴着一张手绘漫画","漫画是美术课代表每周更新的校园搞笑四格，饮水机旁恰好是唯一能看清的角度"],question:"为什么排队不接水？",options:["饮水机坏了","大家在看布告栏上的漫画，假装排队","在等热水烧开"],answer:1,explanation:'美术课代表在布告栏上每周更新四格漫画，成了全班追更的"连载"。大家课间假装来接水，其实是来看最新一期漫画。饮水机旁因此成了学校最受欢迎的"休闲区"。'},{id:"c48",title:"荣誉墙上的陌生面孔",desc:"学校荣誉墙上多了一张谁都不认识的照片",cluesNeeded:4,icon:"🏆",clues:['照片里是一个戴眼镜的老先生，下面的名牌写的是"终身荣誉教师"',"全校老师都不认识这个人，教务系统里也查不到",'照片的相框背后贴着一张纸条："王建国老师，1978-2018，四十年如一日"',"校长看了照片沉默了很久——王建国是学校第一任数学教研组长，去年退休回老家了，学生偷偷把他的照片挂上去的"],question:"陌生面孔是谁？",options:["贴错了照片","退休的老教师，学生偷偷挂上去致敬的","校外人士误入的"],answer:1,explanation:"王建国老师在学校教了四十年数学，去年默默退休回了老家。他的往届学生们觉得学校欠王老师一个正式的荣誉，就偷偷印了照片做了名牌挂上了荣誉墙。校长发现后没有拿下来，而是加了个正式的荣誉框。"},{id:"c49",title:"操场上空的孔明灯",desc:"连续三晚有人在操场放孔明灯，每个灯上都写着不同的愿望",cluesNeeded:5,icon:"🏮",clues:['第一个灯写："希望数学及格"——笔迹歪歪扭扭','第二个灯写："希望妈妈的病快点好"——笔迹很工整','第三个灯写："希望我们都考上理想的高中"——三种不同笔迹',"三个灯都是在晚上9点放的，正好是晚自习放学后十分钟","三个放灯的同学分别来自初三的三个不同班级，他们约好一起放灯祈福，每人写了一个愿望"],question:"孔明灯是谁放的？",options:["校外人员","三个初三学生约好一起放灯为中考祈福","学校组织的活动"],answer:1,explanation:"三个即将面临中考的初三学生，晚自习后约在操场放孔明灯。虽然来自不同班级，但都有一个共同的心愿——考上理想的学校。第三个灯上的三种笔迹就是他们三个人各自的愿望。"},{id:"c50",title:"毕业季的最后一案",desc:"初三毕业生离校后，每个空教室的黑板上都有一段话",cluesNeeded:6,icon:"🎓",clues:["每段话的结尾都画了一个小侦探的简笔画——和本应用 Logo 一模一样",'第一个教室写："三年前我第一次走进这里，现在我要走了"','第二个教室写："谢谢食堂阿姨每次给我多打一勺菜"','第三个教室写："谢谢保安大叔每天在校门口跟我打招呼"','第四个教室写："谢谢保洁阿姨把教室擦得比我家还干净"','第五个教室写："谢谢所有老师，你们是我们遇到过最好的侦探导师"'],question:"黑板上这段话是谁写的？",options:["老师写的送别信","毕业班学生留给母校的感谢信","清洁工写的工作日志"],answer:1,explanation:"毕业班的学生们离校前，在每个教室的黑板上给学校写了一封情书。他们用了本应用的侦探主题——因为在过去三年里，他们就像侦探一样，在这所学校里探索知识、发现世界、找到自己。这不是案子，这是一封写给青春的情书。"}],Fs=.4;function fe(e){return nt[e]||null}function Bt(){return nt.length}async function qe(){const e=await E("active_case");if(!e){const n=nt[0],s={caseIndex:0,caseId:n.id,caseTitle:n.title,cluesCollected:0,cluesNeeded:n.cluesNeeded,collectedClueIndices:[],readyForDeduction:!1};return await q("active_case",s),s}if(e.readyForDeduction===void 0||(!e.collectedClueIndices||e.collectedClueIndices.length===0)&&e.cluesCollected>0){const n=fe(e.caseIndex),s=n&&n.clues?n.clues.length:e.cluesNeeded||0;if(e.cluesCollected>=e.cluesNeeded&&s>0){const a=Math.min(e.cluesCollected,s);e.collectedClueIndices=Array.from({length:a},(i,o)=>o),e.cluesCollected=a,e.readyForDeduction=!0}else e.collectedClueIndices=[],e.readyForDeduction=!1;await q("active_case",e)}return e}async function Ne(){return await E("solved_cases")||[]}async function $s(){const e=await qe();if(e.readyForDeduction)return{dropped:!1};if(Math.random()>Fs)return{dropped:!1};const t=fe(e.caseIndex);if(!t||!t.clues)return{dropped:!1};const n=[];for(let l=0;l<t.clues.length;l++)e.collectedClueIndices.includes(l)||n.push(l);if(n.length===0)return{dropped:!1};const s=n[Math.floor(Math.random()*n.length)],a=[...e.collectedClueIndices,s],i=a.length,o=i>=e.cluesNeeded,v={...e,cluesCollected:i,collectedClueIndices:a,readyForDeduction:o};return await q("active_case",v),{dropped:!0,clueCount:i,clueNeeded:e.cluesNeeded,clueText:t.clues[s],readyForDeduction:o,caseTitle:e.caseTitle,caseIcon:t.icon||"🔍"}}async function Cs(e){const t=await qe(),n=fe(t.caseIndex);return n?e===n.answer?(await Ts(t),{correct:!0,explanation:n.explanation,caseTitle:n.caseTitle}):{correct:!1}:{correct:!1,error:"案件数据丢失"}}async function Ss(){const e=await qe();if(!e.readyForDeduction)return null;const t=fe(e.caseIndex);if(!t)return null;const n=e.collectedClueIndices.sort((s,a)=>s-a).map(s=>t.clues[s]).filter(Boolean);return{caseData:t,collectedClueTexts:n}}async function Ts(e){const t=await Ne();t.push({caseId:e.caseId,caseTitle:e.caseTitle,solvedAt:new Date().toISOString()}),await q("solved_cases",t);const n=e.caseIndex+1,s=fe(n);s?await q("active_case",{caseIndex:n,caseId:s.id,caseTitle:s.title,cluesCollected:0,cluesNeeded:s.cluesNeeded,collectedClueIndices:[],readyForDeduction:!1}):await q("active_case",{...e,caseIndex:n,allSolved:!0,readyForDeduction:!1}),await As(e.caseTitle)}async function As(e){const n={solved:(await E("case_closed")||{solved:0}).solved+1,total:Bt(),lastSolved:e,timestamp:Date.now()};return await q("case_closed",n),n}async function at(){const e=await qe(),t=await Ne(),n=e.allSolved||!1,s=n?null:fe(e.caseIndex)||null;return{activeCase:s?{...s,cluesCollected:e.cluesCollected,progress:e.cluesCollected/e.cluesNeeded,readyForDeduction:e.readyForDeduction||!1}:null,solvedCount:t.length,totalCases:Bt(),allSolved:n}}let Ue=null;function _(e,t="info",n=2500){const s=document.querySelector(".toast-container");s&&s.remove(),Ue&&clearTimeout(Ue);const a=document.createElement("div");a.className="toast-container";const i={success:"&#x2705;",error:"&#x274C;",info:"&#x2139;",warning:"&#x26A0;",star:"&#x2B50;"},o=i[t]||i.info;a.innerHTML=`
  ...
  `,typeof t=="object"&&t.nodeType&&o.querySelector(".modal-body").appendChild(t),o.addEventListener("click",l=>{l.target===o&&Ge(o,s);const c=l.target.closest("[data-btn-index]");if(c){const d=parseInt(c.dataset.btnIndex),r=n[d];r&&r.onClick?r.onClick()!==!1&&Ge(o,s):Ge(o,s)}}),document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add("modal-in");const l=o.querySelector(".modal-container");l&&l.classList.add("modal-container-in")}),o}function Ge(e,t){e.classList.remove("modal-in");const n=e.querySelector(".modal-container");n&&n.classList.remove("modal-container-in"),setTimeout(()=>{e.remove(),t&&t()},250)}function It(e,t,n="确认",s="取消"){return new Promise(a=>{me({title:e,content:`<p style="text-align:center;margin:16px 0;">${h(t)}</p>`,buttons:[{text:s,cls:"btn-secondary",onClick:()=>a(!1)},{text:n,cls:"btn-primary",onClick:()=>a(!0)}]})})}function Ht(e,t="A"){const n={common:"#94A3B8",rare:"#3B82F6",epic:"#8B5CF6",legendary:"#F59E0B"},s={common:"linear-gradient(135deg, #e2e8f0, #cbd5e1)",rare:"linear-gradient(135deg, #bfdbfe, #93c5fd)",epic:"linear-gradient(135deg, #ddd6fe, #c4b5fd)",legendary:"linear-gradient(135deg, #fef3c7, #fcd34d)"},a=n[e.rarity]||"#94A3B8",i=s[e.rarity]||s.common,o=t==="B"?"关键证据":"日常证物";return new Promise(v=>{me({title:`&#x1F50E; 发现${o}！`,className:"blindbox-modal",content:`
      ...
      `,buttons:[{text:"收入证物袋！",cls:"btn-primary",onClick:()=>v(!0)}]})})}function Ds(e){me({title:"&#x1F3C6; 成就解锁！",className:"achievement-modal",content:`
    ...
    `,buttons:[{text:"继续探索",cls:"btn-primary"}]})}function ct(e,t,n=300){if(e)return e.animate(t,{duration:n,easing:"cubic-bezier(0.4, 0, 0.2, 1)",fill:"forwards"})}function _s(e){return ct(e,[{transform:"scale(0.3)",opacity:0},{transform:"scale(1.05)",opacity:.8,offset:.5},{transform:"scale(0.95)",opacity:.9,offset:.7},{transform:"scale(1)",opacity:1}],400)}function Ls(e){return ct(e,[{transform:"translateX(0)"},{transform:"translateX(-6px)",offset:.2},{transform:"translateX(6px)",offset:.4},{transform:"translateX(-4px)",offset:.6},{transform:"translateX(4px)",offset:.8},{transform:"translateX(0)"}],400)}function h(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function M(e,t=document){return t.querySelector(e)}function ze(e,t=document){return Array.from(t.querySelectorAll(e))}function u(e,t={},...n){const s=document.createElement(e);for(const[a,i]of Object.entries(t))a==="className"?s.className=i:a==="innerHTML"?s.innerHTML=i:a==="textContent"?s.textContent=i:a.startsWith("on")?s.addEventListener(a.slice(2).toLowerCase(),i):a==="style"&&typeof i=="object"?Object.assign(s.style,i):s.setAttribute(a,i);for(const a of n)typeof a=="string"?s.appendChild(document.createTextNode(a)):a&&a.nodeType&&s.appendChild(a);return s}function Ns(e){if(e)for(;e.firstChild;)e.removeChild(e.firstChild)}function Me(e){e&&(e.innerHTML=`
  ...
  `,n)){const s=e.querySelector(".retry-btn");s&&s.addEventListener("click",n)}}function js(e,t,n=1){const s=[];for(let a=0;a<n;a++){const i=document.createElement("div");i.className="star-fly",i.textContent="⭐",i.style.cssText=`
      position: fixed;
    ...
    `,document.body.appendChild(i),s.push(i),setTimeout(()=>i.remove(),1e3)}return s}function Es(){const e=document.createElement("div");e.className="case-closed-overlay",e.innerHTML=`
  ...
  `;const n=e.querySelector(".date-nav-prev"),s=e.querySelector(".date-nav-next"),a=e.querySelector(".date-nav-today");n&&n.addEventListener("click",()=>bt(-1)),s&&s.addEventListener("click",()=>bt(1)),a&&a.addEventListener("click",()=>Bs()),ot(e),dt(e)}function bt(e){let t=ce(H,e);if(t<O.startDate&&(t=O.startDate),t>W()&&(t=W()),t===H)return;H=t;const n=document.querySelector("#dateNav");n&&(ot(n),dt(n)),$e&&$e(H)}function Bs(){const e=W();if(H===e)return;H=e;const t=document.querySelector("#dateNav");t&&(ot(t),dt(t)),$e&&$e(H)}function ot(e){if(!e)return;const t=e.querySelector(".date-nav-text"),n=e.querySelector(".date-nav-prev"),s=e.querySelector(".date-nav-next");if(t){const a=H===W();t.innerHTML=`${oe(H)}${a?' <span class="today-badge">今天</span>':""}`}n&&(n.disabled=H<=O.startDate),s&&(s.disabled=H>=W())}async function dt(e){if(!e)return;const t=e.querySelector(".date-nav-badges");if(t)try{const s=(await pe()).todayProgress.filter(l=>l.date===H),a=I(H),i=Q(H),o=V(H);let v="";if(a&&(v+='<span class="date-badge badge-rest">休息日</span>'),i&&(v+='<span class="date-badge badge-travel">旅行中</span>'),o||(v+='<span class="date-badge badge-future">未开始</span>'),s.length>0){const l=s.reduce((c,d)=>c+d.stars,0);v+=`<span class="date-badge badge-stars">&#x2B50; ${l}</span>`,v+=`<span class="date-badge badge-count">${s.length}项</span>`}t.innerHTML=v}catch{t.innerHTML=""}}async function ie(e){if(e)try{const t=await pe(),n=await Mt(),s=await at();let a="";if(s.allSolved)a=`
    ...
    `}catch(t){console.error("renderHeaderStats failed:",t),e.innerHTML='<div class="header-stats-error">统计加载失败</div>'}}function Ot(){return H}const Is=[{id:"a01",icon:"🔍",title:"放大镜",desc:"经典侦探工具，帮你发现隐藏的线索",rarity:"common"},{id:"a02",icon:"📇",title:"便签本",desc:"记录关键信息的侦探便签",rarity:"common"},{id:"a03",icon:"📷",title:"取证相机",desc:"拍下现场照片，定格关键瞬间",rarity:"common"},{id:"a04",icon:"✍",title:"铅笔头",desc:"每位侦探都有一支最顺手的铅笔",rarity:"common"},{id:"a05",icon:"🧪",title:"证物袋",desc:"收集并保存现场证物的专用袋",rarity:"common"},{id:"a06",icon:"📏",title:"比例尺",desc:"精确测量线索，不放过任何细节",rarity:"common"},{id:"a07",icon:"📎",title:"图钉",desc:"把线索钉在软木板上，串联推理",rarity:"common"},{id:"a08",icon:"🧲",title:"磁铁",desc:"在灰烬中寻找金属微粒的好帮手",rarity:"common"},{id:"a09",icon:"📥",title:"档案袋",desc:"整理案件资料的牛皮纸档案袋",rarity:"common"},{id:"a10",icon:"📋",title:"线索板",desc:"把所有线索钉在板上，拼出真相",rarity:"rare"},{id:"a11",icon:"🧪",title:"指纹粉",desc:"撒上粉末，隐藏的指纹立刻显现",rarity:"rare"},{id:"a12",icon:"📠",title:"对讲机",desc:"与搭档保持联络的便携对讲机",rarity:"rare"},{id:"a13",icon:"🔬",title:"显微镜",desc:"观察微观证据，发现肉眼看不到的真相",rarity:"rare"},{id:"a14",icon:"📜",title:"旧报纸",desc:"泛黄的报纸里藏着尘封的往事",rarity:"rare"},{id:"a15",icon:"🧭",title:"指南针",desc:"在迷雾中不迷失方向",rarity:"rare"},{id:"a16",icon:"🔑",title:"万能钥匙",desc:"打开所有上锁的房间，但记得先敲门",rarity:"epic"},{id:"a17",icon:"🧳",title:"密码本",desc:"破译加密信息的专属密码本",rarity:"epic"},{id:"a18",icon:"🎷",title:"侦探口琴",desc:"布鲁斯口琴，每个名侦探都有自己的BGM",rarity:"epic"}],Hs=[{id:"b01",icon:"💿",title:"监控录像",desc:"案发当晚的监控画面，画面中有一个背影",rarity:"common"},{id:"b02",icon:"📨",title:"神秘信件",desc:'没有署名，信纸上只有一行字："明天下午三点"',rarity:"common"},{id:"b03",icon:"☕",title:"半杯咖啡",desc:"还温热的咖啡，嫌疑人刚刚离开不久",rarity:"common"},{id:"b04",icon:"👟",title:"泥泞的鞋印",desc:"43码运动鞋，鞋底有独特的菱形花纹",rarity:"common"},{id:"b05",icon:"📱",title:"未接来电",desc:"通话记录显示凌晨2:15有一个陌生号码来电",rarity:"common"},{id:"b06",icon:"📄",title:"半张纸条",desc:'被撕掉一半的纸条，剩余部分写着："...藏在钟楼..."',rarity:"common"},{id:"b07",icon:"🎲",title:"一枚骰子",desc:"特制骰子，六个面都是同样的点数",rarity:"common"},{id:"b08",icon:"🧤",title:"断裂的钥匙",desc:"青铜材质，断口处有撬动的痕迹",rarity:"common"},{id:"b09",icon:"💍",title:"吊坠项链",desc:"银质吊坠，内侧刻着两个字母",rarity:"common"},{id:"b10",icon:"📰",title:"剪报",desc:"三年前的新闻剪报，报道了一起未破的盗窃案",rarity:"rare"},{id:"b11",icon:"🎤",title:"录音带",desc:"老式磁带，播放后有30秒的奇怪录音",rarity:"rare"},{id:"b12",icon:"💰",title:"外国纸币",desc:"一张不在市面流通的外币，序列号被红笔圈出",rarity:"rare"},{id:"b13",icon:"🧮",title:"数字密码",desc:'一张写着"8-15-23"的便条，是什么意思？',rarity:"rare"},{id:"b14",icon:"🏞",title:"老照片",desc:"褪色照片中的建筑，似乎就在学校附近",rarity:"rare"},{id:"b15",icon:"🏹",title:"监控照片",desc:"抓拍到一辆未挂车牌的黑色轿车",rarity:"rare"},{id:"b16",icon:"📦",title:"匿名包裹",desc:"快递盒里只有一个U盘和一封打印的信",rarity:"epic"},{id:"b17",icon:"📔",title:"嫌疑人日记",desc:"日记中记录了连续一周的异常行踪",rarity:"epic"},{id:"b18",icon:"🏆",title:"决定性证据",desc:"铁证如山！这个证据足以让案件水落石出",rarity:"legendary"}],gt=[{id:"dc01",icon:"🔎",title:"观察力试炼",desc:"留意今天身边3个不同的细节，像侦探一样观察世界"},{id:"dc02",icon:"🧠",title:"推理力试炼",desc:'对今天学到的一个知识点，问三个"为什么"'},{id:"dc03",icon:"💪",title:"毅力试炼",desc:"坚持完成今天的所有任务，不半途而废"},{id:"dc04",icon:"📝",title:"记忆力试炼",desc:"睡前回忆今天解锁的3个新知识，默记于心"},{id:"dc05",icon:"💬",title:"沟通力试炼",desc:"向家人讲述一个你今天学到的有趣知识"},{id:"dc06",icon:"🧩",title:"解谜试炼",desc:"尝试解开一个谜题：数独、字谜或数学题都可以"}],wt=[{id:"ec01",text:"真相往往藏在最不起眼的细节里，保持你的观察力。",icon:"🔍"},{id:"ec02",text:"每个名侦探都是从第一个案子起步的，你做得很好。",icon:"💪"},{id:"ec03",text:"排除所有不可能，剩下的即使再不可思议，那也是真相。",icon:"💡"},{id:"ec04",text:"线索不会自己上门，需要你用每一天的坚持去寻找。",icon:"🔎"},{id:"ec05",text:'华生说："你每天都有新的进步。"福尔摩斯点了点头。',icon:"🧐"},{id:"ec06",text:"今天的努力，是明天破案时最锋利的武器。",icon:"⚔"},{id:"ec07",text:'侦探从不说"放弃"，他们说"换个角度"。',icon:"🔄"},{id:"ec08",text:"世界上最厉害的侦探，是那个从不停止学习的人。",icon:"🌍"}],Xe=["🔍 细节之中，藏着世界的秘密。","💡 好奇心是侦探的第一把钥匙。","💪 今天的坚持，是明天的超能力。","🌟 你不是在完成任务，你是在收集改变自己的力量。","🧐 真正的侦探不是最聪明的，而是最专注的。","🔥 点燃你的热情，比点燃一支蜡烛更有用。","📚 书页之间，藏着你还没发现的宝藏。","✏ 每一个单词都是一块拼图，别停下来。","🔄 失败了？换个角度，再来一次。","🌍 你今天学到的，会让明天的世界更清晰。","🎯 设定目标，然后像狙击手一样瞄准它。","🌈 暴风雨后才有彩虹，努力过后才有惊喜。","⛰ 每座高山都是从第一块石头开始的。","💪 没有天生的名侦探，只有不断练习的普通人。","🌞 早起的人，先看到真相。","🌿 成长就像植物，看不见变化，但它一直在长。","💧 滴水穿石，不是因为力量，而是因为坚持。","🏃 跑得慢没关系，只要不停下来。","💭 想法不值钱，执行才值钱。今天你执行了吗？","🎉 进步不分大小，每一步都值得庆祝。","📍 把大目标切成小块，一口一口吃掉它。","🌀 昨天的你无法改变，但今天可以。","🐌 蚂蚁虽小，能搬动比它重几十倍的东西。","🌟 你就是自己故事里的主角，别让主角偷懒。","🎵 学习像弹琴，练得越多，旋律越美。","🌙 即使月亮有时不圆，但它从未停止发光。","☁ 不要让坏心情遮住你的天空。","💪 你的潜力比你想象的大得多。","🔎 发现自己的弱点，是变强的第一步。","💤 累了就休息，休息好了再出发。","⚔ 知识是你最锋利的武器，每天磨一磨。","🌟 没人能随随便便成功，但你可以一步步接近。","📖 书是侦探最好的朋友，别冷落它。","🎯 专注比聪明更重要，今天专注了吗？","🌞 阳光总在风雨后，先完成今天的任务再说。","📣 大声告诉自己：我可以！","🧠 脑子越用越灵，跟肌肉一样需要锻炼。","🌊 海浪从不停止拍打岸边，你也别停下脚步。","🐬 龟兔赛跑告诉我们：坚持比速度更重要。","🌟 做最好的自己，而不是别人的复制品。","💎 压力是碳变成钻石的唯一途径。","💪 自信不是天生的，是一个个小胜利累积的。","🌸 像花一样慢慢开，你的时间会来的。","🌌 星空之所以美，是因为每颗星都在发光。你也是一颗星。","⚡ 行动是消除焦虑的唯一办法。","🏆 冠军不是一场比赛诞生的，是每一次训练堆出来的。","💡 不懂就问，这是侦探的基本素养。","🔄 用不同的方法试试，总有一条路能通。","🌍 这个世界不缺聪明人，缺的是坚持到底的人。","🌟 今天的你，比昨天更厉害了一点。","🌸 每朵花都有自己的花期，你也是。","🦋 蝴蝶破茧前，也是一只不起眼的毛毛虫。","⛵ 风平浪静造就不了优秀的水手。","💪 你比你想象的更强大。","🎯 成功是一步步瞄准，一次次射击。","📖 每天多读一页书，一年就多了365页的智慧。","🌟 发光不是太阳的专利，你也可以。","💡 好主意往往在努力之后才出现。","🧠 脑子越用越灵光，今天你动脑了吗？","🌈 风雨过后不一定有彩虹，但一定有晴天。","🏃 不要跟别人比速度，要跟自己比进步。","🌱 成长像小树苗，看不见变化，却一直在扎根。","📍 把大目标切成小块，一口一口吃掉。","🌞 每一个清晨都是重新开始的机会。","💎 压力让碳变成钻石，让你变得更强。","🔥 热情是最好的老师，保持你的好奇心。","🌊 浪潮退去才知道谁在裸泳，努力的人从不怕考验。","🏆 没有人能随随便便成功，但你可以踏踏实实进步。","🧘 累了就歇一会儿，休息好了再出发。","💤 充足的睡眠是超能力，别熬夜。",'💬 说"我可以"比说"我不行"多用不了多少力气。',"🌟 你是独一无二的，没人能替代你发光。","🐩 像兔子一样敏捷思考，像乌龟一样坚持到底。","💪 今天多努力一点，明天就少后悔一点。"],Wt=[{id:"happy",icon:"😊",label:"开心"},{id:"excited",icon:"🤩",label:"兴奋"},{id:"confident",icon:"😎",label:"自信"},{id:"calm",icon:"😌",label:"平静"},{id:"curious",icon:"🤔",label:"好奇"},{id:"enlightened",icon:"💡",label:"开窍"},{id:"tired",icon:"😴",label:"疲惫"},{id:"annoyed",icon:"😤",label:"烦躁"},{id:"determined",icon:"💪",label:"加油"}],kt=Is,xt=Hs,Ye=[{id:"hw_yw_01",subject:"语文",title:"背诵八上古诗文并默写",desc:"篇目见附录1",detail:"理解古诗文大意后熟读成诵，并默写在本子上。篇目包含八上全部古诗文（三峡、答谢中书书、记承天寺夜游、与朱元思书、野望、黄鹤楼、使至塞上、渡荆门送别、钱塘湖春行、庭中有奇树、龟虽寿、赠从弟、梁甫行、得道多助失道寡助、富贵不能淫、生于忧患死于安乐、愚公移山、周亚夫军细柳、饮酒、春望、雁门太守行、赤壁、渔家傲、浣溪沙、采桑子、相见欢、如梦令）。开学后课堂检测。"},{id:"hw_yw_02",subject:"语文",title:"文创设计三选一",desc:"书签 / 扇面 / 帆布包",detail:`选项A·书签设计：选取6句最喜欢的诗句，设计一套3张主题书签。正面为诗句+意境插画，背面为出处、释义，尺寸6×15cm。建议围绕同一主题选句（如"山水""边塞""家国情怀"）。
...
完整流程：准备热身→动态热身→基础体能→球类专项→拉伸放松。打印作业文档，每日如实记录，禁止空白填写和事后补填。开学第一周由体育委员统一收集，附运动轨迹截图或照片。`},{id:"hw_ty_02",subject:"体育",title:"足球文化拓展作业",desc:"科普短文350字 / 世界杯手抄报A4（二选一）",detail:"查阅资料了解足球起源、现代足球发展历程，学习正规比赛基础规则（比赛时长、得分规则、界外球、点球、红黄牌犯规判定、换人规则）。成果提交二选一：①撰写350字左右足球知识科普短文或世界杯比赛赏析文章；②绘制A4世界杯手抄报，内容可包含自己喜欢的球队和球星。开学第一周提交。"}];function Ft(){const e=Math.floor(Math.random()*kt.length);return kt[e]}function Ps(){const e=Math.floor(Math.random()*xt.length);return xt[e]}function Os(){const e=Math.floor(Math.random()*wt.length);return wt[e]}async function Rt(e){const t=await Ze(e),n=e||W(),s=t.filter(r=>r.date===n),a=[];new Set(s.map(r=>r.subjectId)).size>=3&&a.push({type:"box_a",reason:"今日完成3类以上任务",box:Ft()}),s.reduce((r,f)=>r+f.stars,0)>=5&&a.push({type:"box_b",reason:"今日获得5颗以上星星",box:Ps()});const l=(await et()).filter(r=>r.suggestedDate===n).map(r=>r.taskId),c=s.map(r=>r.taskId);return l.length>0&&l.every(r=>c.includes(r))&&a.push({type:"bonus",reason:"完成今日所有建议任务",box:Ft()}),a}function Ws(e){return gt[e%gt.length]}async function Ut(){return await E("blindbox_history")||[]}async function Gt(e){const t=await Ut();return t.unshift({...e,openedAt:new Date().toISOString()}),t.length>50&&(t.length=50),await q("blindbox_history",t),t}let ke=null;function zt(){return ke||(ke=new(window.AudioContext||window.webkitAudioContext)),ke.state==="suspended"&&ke.resume(),ke}function ae(e,t,n="sine",s=.3){try{const a=zt(),i=a.createOscillator(),o=a.createGain();i.type=n,i.frequency.value=e,o.gain.setValueAtTime(s,a.currentTime),o.gain.exponentialRampToValueAtTime(.001,a.currentTime+t),i.connect(o),o.connect(a.destination),i.start(a.currentTime),i.stop(a.currentTime+t)}catch{}}function Xt(e,t=.12){e.forEach(([n,s],a)=>{setTimeout(()=>ae(n,s*t,"sine",.25),a*t*200)})}function Ie(){ae(880,.1,"sine",.3),setTimeout(()=>ae(1100,.2,"sine",.25),80)}function Yt(){ae(400,.15,"triangle",.2),setTimeout(()=>ae(500,.1,"triangle",.2),120),setTimeout(()=>ae(600,.1,"triangle",.2),220),setTimeout(()=>ae(800,.15,"triangle",.3),300),setTimeout(()=>{Xt([[660,1],[880,1],[1100,3]])},500)}function Kt(){Xt([[523,1],[659,1],[784,1],[1047,1],[784,1],[1047,1],[1319,3]],.1)}function He(){ae(300,.15,"square",.15),setTimeout(()=>ae(250,.25,"square",.15),120)}function Rs(){try{const e=zt();e.state==="suspended"&&e.resume(),ae(1,.001,"sine",0)}catch{}}async function G(e,t,n=!1){if(!e)return;const s=t||Ot()||W(),a=n?window.scrollY:0;try{Me(e);const i=await Ze(s),o=new Set(i.map(c=>c.taskId)),v=Ws(os(s));e.innerHTML="";const l=u("div",{className:"search-header"});if(l.innerHTML=`
    ...
    `,e.appendChild(l),I(s)){const c=u("div",{className:"sunday-page"});try{const d=await pe(),r=await E("diary")||{},f=Object.keys(r).sort().reverse().slice(0,3);c.innerHTML=`
          ...
          <div class="sunday-stats-grid">
            <div class="sunday-stat">
              <div class="sunday-stat-value">${d.streak}</div>
              <div class="sunday-stat-label">连续打卡</div>
            </div>
            <div class="sunday-stat">
              <div class="sunday-stat-value">${d.totalStars}</div>
              <div class="sunday-stat-label">累计星星</div>
            </div>
            <div class="sunday-stat">
              <div class="sunday-stat-value">${d.activeDays}</div>
              <div class="sunday-stat-label">活跃天数</div>
            </div>
            <div class="sunday-stat">
              <div class="sunday-stat-value">${d.reciteCompleted}/${d.reciteTotal}</div>
            ...
            <div class="sunday-diary-section">
              ...
              ${f.map(p=>{var y,b;return`
                <div class="sunday-diary-item">
                  ...
                  <div class="sunday-diary-text">${h((((y=r[p])==null?void 0:y.text)||"").slice(0,100))}${(((b=r[p])==null?void 0:b.text)||"").length>100?"...":""}</div>
                </div>
              `}).join("")}
            </div>
          `:""}
        ...
        `}catch{c.innerHTML=`
          ...
          <h2 class="sunday-title">侦探休息日</h2>
          <p class="sunday-subtitle">今天是周日，好好休息，养精蓄锐！</p>
        `}e.appendChild(c);return}if(V(s)&&!I(s)){const c=await E("avatar")||"",d=u("div",{className:"search-section avatar-section"});d.innerHTML=`
      ...
      `,e.appendChild(d);const r=d.querySelector("#avatarWrapper"),f=d.querySelector("#avatarInput");r.addEventListener("click",()=>f.click()),f.addEventListener("change",async p=>{const y=p.target.files[0];if(!y)return;const b=new FileReader;b.onload=async()=>{await q("avatar",b.result),r.innerHTML=`
            <img src="${b.result}" class="avatar-img" alt="我的画像">
            <div class="avatar-edit-hint">&#x270F;</div>
          `},b.readAsDataURL(y)})}if(V(s)&&!I(s)){const c=await E("daily_quotes")||{},d=c[s],r=await E("moods")||{},f=r[s],p=u("div",{className:"search-section"});p.innerHTML=`
        <div class="daily-row">
          <!-- 抽签区 -->
          <div class="daily-quote-draw ${d?"drawn":""}" id="quoteDraw">
            ${d?`
              <div class="quote-fortune-paper">
                <div class="quote-fortune-label">&#x1F340; 今日好运</div>
                <div class="quote-fortune-text">${h(d)}</div>
              </div>
            `:`
      ...
      `,e.appendChild(p);const y=p.querySelector("#btnDrawQuote");y&&y.addEventListener("click",async()=>{const b=await E("drawn_quote_indices")||[];let k=[];for(let j=0;j<Xe.length;j++)b.includes(j)||k.push(j);if(k.length===0){b.length=0;for(let j=0;j<Xe.length;j++)k.push(j)}const $=k[Math.floor(Math.random()*k.length)];b.push($),await q("drawn_quote_indices",b);const S=Xe[$];c[s]=S,await q("daily_quotes",c);const A=p.querySelector("#quoteDraw");A.classList.add("drawn"),A.innerHTML=`
          ...
          `}),p.querySelectorAll(".mood-btn").forEach(b=>{b.addEventListener("click",async()=>{const k=b.dataset.mood;r[s]=k,await q("moods",r),p.querySelectorAll(".mood-btn").forEach($=>$.classList.remove("mood-selected")),b.classList.add("mood-selected")})})}if(v&&V(s)&&!I(s)&&!Q(s)){const c=u("div",{className:"search-section challenge-section"});c.innerHTML=`
      ...
      `,e.appendChild(c)}if(!I(s)){const c=u("div",{className:"search-section search-recite"});c.innerHTML='<div class="section-title">&#x1F4D6; 背诵任务</div>';const d=le.filter(p=>p.type==="recite"),r=cs(s),f=Q(s);for(const p of d){const y=tt().filter(T=>T.subject===p.id),b=y.filter(T=>o.has(T.id)).length,k=u("div",{className:"subject-block"});k.innerHTML=`
        ...
        `;const $=u("div",{className:"task-list"}),S=3,A=y.filter(T=>!o.has(T.id)),j=A.slice(0,S),R=A.slice(S);for(const T of j)$.appendChild($t(T,!1,s));if(R.length>0){const T=u("div",{className:"task-collapse-content",style:{display:"none"}});for(const x of R)T.appendChild($t(x,!1,s));const N=u("button",{className:"btn-task-expand",onClick:function(){const x=T.style.display!=="none";T.style.display=x?"none":"block",this.innerHTML=x?`展开全部 (${R.length}条) ▼`:"收起 ▲"}},`展开全部 (${R.length}条) ▼`);$.appendChild(T),$.appendChild(N)}if(!f||p.id==="en"){const T=vs(p.id,s,r);for(const N of T){const x=`daily_${N.id}`,B=o.has(x),te=Gs(N,B,s,p);B&&te.classList.add("task-done"),$.appendChild(te)}}k.appendChild($),c.appendChild(k)}e.appendChild(c)}if(!I(s)&&!Q(s)){const c=u("div",{className:"search-section"});c.innerHTML='<div class="section-title">&#x1F3C3; 体能训练</div>';const d=u("div",{className:"task-list horizontal-list"});for(const r of Lt){const f=`sp_${r.id}`,p=o.has(f),y=Us(r,p,s);d.appendChild(y)}c.appendChild(d),e.appendChild(c)}if(!I(s)&&!Q(s)){const c=u("div",{className:"search-section"});c.innerHTML='<div class="section-title">&#x1F4D0; 学科任务</div>';const d=le.filter(r=>r.type==="chapter");for(const r of d){const f=ks(r.id,s);if(!f||f.length===0)continue;let p=0,y=0;for(const k of f)for(const $ of k.items)p++,o.has($.id)&&y++;const b=u("div",{className:"subject-block chapter-subject-block"});b.innerHTML=`
          <div class="subject-header chapter-subject-header" style="border-left: 4px solid ${r.color};">
            <span class="subject-icon">${r.icon}</span>
            <span class="subject-name">${h(r.name)}</span>
        ...
        `;for(const k of f){const $=k.items.filter(x=>o.has(x.id)).length,S=k.items.length,A=u("div",{className:"chapter-group"});A.innerHTML=`
            <div class="chapter-group-header" data-chapter-group="${r.id}_${k.chapterIndex}">
            ...
            <div class="chapter-group-items" id="ch_group_${r.id}_${k.chapterIndex}" style="display:none;">
          ...
          `;const j=A.querySelector(".chapter-group-header"),R=A.querySelector(".chapter-group-items"),T=A.querySelector(".chapter-group-arrow");j.addEventListener("click",()=>{const x=R.style.display!=="none";R.style.display=x?"none":"block",T.textContent=x?"▶":"▼"}),A.querySelectorAll(".chapter-item").forEach(x=>{x.addEventListener("click",async()=>{const B=x.dataset.taskId,te=o.has(B),be={id:B,subject:r.id,title:x.querySelector(".chapter-item-title").textContent,content:""};await Pe(be,te,s,x)})}),b.appendChild(A)}c.appendChild(b)}e.appendChild(c)}if(V(s)&&!I(s))try{const c=await Ss();if(c){const d=u("div",{className:"search-section deduction-ready-section"});d.innerHTML=`
          ...
          `,d.querySelector(".btn-deduction-start").addEventListener("click",async()=>{await Ys(c.caseData,c.collectedClueTexts,s),await G(e,s,!0);const f=document.querySelector("#headerStats");f&&ie(f);const p=document.querySelector("#sideStats");p&&ie(p)}),e.appendChild(d)}}catch(c){console.error("Deduction check failed:",c)}if(V(s)&&!I(s)){const c=await de(),d=new Set(c.filter(S=>S.taskId&&S.taskId.startsWith("hw_")).map(S=>S.taskId)),r=Ye.filter(S=>d.has(S.id)).length,f=Ye.length,p=u("div",{className:"search-section"}),y={语文:"#EF4444",数学:"#3B82F6",英语:"#8B5CF6",道法:"#F59E0B",历史:"#10B981",体育:"#06B6D4"},b=["语文","数学","英语","道法","历史","体育"],k=f>0?Math.round(r/f*100):0;p.innerHTML=`
        <div class="section-title" style="cursor:pointer;" id="hwSectionTitle">
          &#x1F4DA; 暑假作业 <span class="hw-progress-badge">${r}/${f}</span>
      ...
      `;const $=u("div",{className:"hw-list"});for(const S of b){const A=Ye.filter(x=>x.subject===S);if(A.length===0)continue;const j=A.filter(x=>d.has(x.id)).length,R=u("div",{className:"hw-subject-group"}),T=u("div",{className:`hw-subject-header ${j===A.length?"hw-subject-all-done":""}`,style:`border-left:3px solid ${y[S]};`});T.innerHTML=`
          <span class="hw-subj-dot" style="background:${y[S]};"></span>
          <span class="hw-subj-name">${S}</span>
          <span class="hw-subj-count">${j}/${A.length}</span>
          <span class="hw-subj-arrow">&#x25B6;</span>
        `;const N=u("div",{className:"hw-subject-items",style:"display:none;"});for(const x of A){const B=d.has(x.id),te=u("div",{className:`hw-item ${B?"hw-done":""}`,"data-task-id":x.id});te.innerHTML=`
          ...
          `,te.addEventListener("click",()=>{me({title:x.subject+" - "+x.title,content:`<div style="font-size:13px;line-height:1.8;white-space:pre-wrap;color:var(--color-text);">${h(x.detail||x.desc)}</div>`,buttons:[{text:"关闭",cls:"btn-secondary"}]})}),te.querySelector(".btn-task-toggle").addEventListener("click",async ge=>{ge.stopPropagation(),B?(await Ee(x.id,s),_("已撤销"),await G(e,s,!0)):(await je(x.id,s,{customTitle:x.title,customContent:x.desc,subjectId:x.subject})).state.action==="completed"&&(Ie(),it(1),await G(e,s,!0))}),N.appendChild(te)}T.addEventListener("click",()=>{const x=N.style.display!=="none";N.style.display=x?"none":"block",T.querySelector(".hw-subj-arrow").innerHTML=x?"&#x25B6;":"&#x25BC;"}),R.appendChild(T),R.appendChild(N),$.appendChild(R)}p.appendChild($),e.appendChild(p)}if(V(s)){const c=u("div",{className:"search-section"});c.innerHTML='<div class="section-title">&#x1F3AF; 特别行动</div>';const d=u("div",{className:"task-list"}),r=i.filter(p=>p.subjectId==="ot");for(const p of r){const y=zs(p,s);d.appendChild(y)}const f=u("button",{className:"btn btn-add-custom",onClick:async()=>{await Ks(s,e)}},"+ 添加特别行动");d.appendChild(f),c.appendChild(d),e.appendChild(c)}if(i.length>0){const c=u("div",{className:"search-section summary-section"}),d=i.reduce((r,f)=>r+f.stars,0);c.innerHTML=`
        <div class="section-title">&#x2705; 今日已完成 (${i.length}项 / &#x2B50;${d}星)</div>
      `;try{const r=await Rt(s);if(r.length>0){const f=u("div",{className:"blindbox-triggers"});for(const p of r){const y=u("button",{className:"btn btn-blindbox",onClick:async()=>{Yt(),await Gt(p.box),await Ht(p.box,p.type==="box_b"?"B":"A"),G(e,s,!0)}},`${p.type==="box_b"?"&#x1F50E; 关键证据":p.type==="bonus"?"&#x1F3C6; 额外发现":"&#x1F50D; 日常证物"} - ${h(p.reason)}`);f.appendChild(y)}c.appendChild(f)}}catch(r){console.error("Blindbox trigger check failed:",r)}e.appendChild(c)}if(V(s)&&!I(s)){const c=u("div",{className:"search-section diary-write-section"});c.innerHTML='<div class="section-title">&#x1F4DD; 探案笔记</div>';const d=await E("diary")||{},r=d[s],f=s===W();if(r&&r.text){c.innerHTML+=`
          <div class="diary-write-card diary-written">
            <div class="diary-write-text">${h(r.text)}</div>
            ${r.stars?`<div class="diary-write-stars">&#x2B50; 当天获得 ${r.stars} 星</div>`:""}
          ...
          <div class="diary-edit-area" style="display:none;">
            <textarea class="diary-textarea" rows="3" maxlength="500">${h(r.text)}</textarea>
        ...
        `,e.appendChild(c);const y=c.querySelector(".diary-save-btn"),b=c.querySelector("#diaryTextarea");y.addEventListener("click",async()=>{const k=b.value.trim();if(!k){_("请写点什么吧","warning");return}d[s]={text:k,stars:p},await q("diary",d),_("&#x1F4DD; 笔记已记录！"),await G(e,s,!0)})}e.appendChild(c)}if(i.length===0&&V(s)&&!I(s)&&!Q(s)){const c=Os(),d=u("div",{className:"search-section encourage-section"});d.innerHTML=`
        <div class="encourage-card">
          <div class="encourage-icon">${c.icon}</div>
          <div class="encourage-text">${h(c.text)}</div>
        </div>
      `,e.appendChild(d)}n&&a>0&&requestAnimationFrame(()=>{requestAnimationFrame(()=>{window.scrollTo(0,a)})})}catch(i){console.error("renderTabSearch failed:",i),Be(e,`页面加载失败: ${i.message}`,()=>G(e,s))}}function $t(e,t,n){const s=Je(e.subject),a=u("div",{className:"task-card ","data-task-id":e.id}),i=e.content?`<div class="task-card-preview">${h(e.content.slice(0,50))}${e.content.length>50?"...":""}</div>`:"";a.innerHTML=`
  ...
  `;const o=a.querySelector(".btn-task-toggle");return o&&o.addEventListener("click",async v=>{v.stopPropagation(),await Pe(e,t,n,a)}),a.addEventListener("click",()=>{Xs(e,t,n)}),ct(a,[{opacity:0,transform:"translateY(10px)"},{opacity:1,transform:"translateY(0)"}],200),a}function Us(e,t,n){const s=`sp_${e.id}`,a=u("div",{className:`task-card sport-card ${t?"task-card-done":""}`,"data-task-id":s});a.innerHTML=`
    <div class="sport-icon">${e.icon}</div>
    <div class="sport-name">${h(e.name)}</div>
    <button class="btn-task-toggle ${t?"btn-task-undo":"btn-task-do"}">
      ${t?"&#x2705;":"&#x2B50;"}
    </button>
  `;const i=a.querySelector(".btn-task-toggle");return i&&i.addEventListener("click",async o=>{o.stopPropagation();const v={id:s,subject:"sp",title:e.name,content:""};await Pe(v,t,n,a)}),a}function Gs(e,t,n,s){const a=`daily_${e.id}`,i=u("div",{className:`task-card daily-task-card ${t?"task-card-done":""}`,"data-task-id":a});i.innerHTML=`
    <div class="task-card-left">
  ...
  `;const o=i.querySelector(".btn-task-toggle");return o&&o.addEventListener("click",async v=>{v.stopPropagation();const l={id:a,subject:"daily",title:e.title,content:""};await Pe(l,t,n,i)}),i}function zs(e,t){const n=u("div",{className:"task-card custom-card task-card-done","data-task-id":e.taskId});n.innerHTML=`
    <div class="task-card-left">
  ...
  `;const s=n.querySelector(".btn-task-toggle");return s&&s.addEventListener("click",async a=>{if(a.stopPropagation(),(await Ee(e.taskId,t)).state.action==="undone"){He(),_("已撤销");const o=n.closest(".tab-content");o&&G(o,t,!0)}}),n}async function Pe(e,t,n,s){try{if(t){if(!await It("撤销确认",`确定要撤销「${e.title}」的完成记录吗？星星也将被收回。`))return;if((await Ee(e.id,n)).state.action==="undone"){He(),_(`已撤销「${e.title}」`);const o=document.querySelector("#tabSearch");o&&G(o,n,!0)}}else{const a=await je(e.id,n);if(a.state.action==="completed"){Ie();const i=a.state.stars;if(it(i),s){const d=s.getBoundingClientRect();js(d.left+d.width/2,d.top,i),s.classList.add("task-card-done");const r=s.querySelector(".btn-task-toggle");r&&(r.innerHTML="&#x2705;",r.className="btn-task-toggle btn-task-undo"),_s(s)}try{const d=await $s();if(d.dropped&&!d.readyForDeduction){const r=document.createElement("div");r.className="clue-toast",r.innerHTML=`🔍 发现线索！(${d.clueCount}/${d.clueNeeded})<br><small>「${d.caseTitle}」</small>`,r.style.cssText=`
            ...
            `,document.body.appendChild(r),setTimeout(()=>r.remove(),2200)}d.readyForDeduction&&_(`🔍 线索集齐！准备推理「${d.caseTitle}」`,"info",3e3)}catch(d){console.error("Clue drop failed:",d)}if(a.events.includes("achievement_unlocked")){const d=await Le(),r=d[d.length-1];r&&(Kt(),await Ds(r))}const o=await Rt(n);if(o.length>0)for(const d of o)Yt(),await Gt(d.box),await Ht(d.box,d.type==="box_b"?"B":"A");const v=document.querySelector("#tabSearch");v&&await G(v,n,!0);const l=document.querySelector("#headerStats");l&&ie(l);const c=document.querySelector("#sideStats");c&&ie(c);try{const d=await pe();qs(d.streak)}catch{}}}}catch(a){console.error("Task toggle failed:",a),_(`操作失败: ${a.message}`,"error")}}function Xs(e,t,n){const s=Je(e.subject);let a=`
  ...
  `,me({title:"",content:a,buttons:[{text:"关闭",cls:"btn-secondary"},{text:"完成",cls:"btn-primary",onClick:async()=>{{const o=await je(e.id,n);Ie(),it(o.state.stars)}const i=document.querySelector("#tabSearch");i&&G(i,n,!0)}}]})}async function Ys(e,t,n){return new Promise(s=>{let a=-1,i=!1;function o(){return`
        <div class="deduction-modal-content">
            ...
            <div class="deduction-clues-list">
              ${t.map((c,d)=>`
                <div class="deduction-clue-card">
                  <span class="deduction-clue-num">${d+1}</span>
          ...
          <div class="deduction-question-section">
            ...
            <div class="deduction-options" id="deductionOptions">
              ${e.options.map((c,d)=>`
                <button class="deduction-option" data-answer="${d}">
                  <span class="deduction-option-letter">${String.fromCharCode(65+d)}</span>
      ...
      `}const v=me({title:"",className:"deduction-modal",content:o(),buttons:[{text:"&#x1F50D; 提交推理",cls:"btn-primary btn-submit-deduction",onClick:()=>i?!1:a<0?(_("请先选择一个答案","warning"),!1):(l(),!1)}],onClose:()=>s(null)});v.querySelectorAll(".deduction-option").forEach(c=>{c.addEventListener("click",()=>{i||(a=parseInt(c.dataset.answer),v.querySelectorAll(".deduction-option").forEach(d=>d.classList.remove("selected")),c.classList.add("selected"))})});async function l(){i=!0;const c=await Cs(a),d=v.querySelector(".deduction-feedback"),r=v.querySelector(".btn-submit-deduction");if(c.correct){Kt();const f=v.querySelector(`.deduction-option[data-answer="${e.answer}"]`);f&&f.classList.add("correct"),d.style.display="block",d.className="deduction-feedback feedback-correct",d.innerHTML=`&#x2705; 推理正确！${h(c.explanation)}`,r&&(r.innerHTML="&#x1F36C; 案件告破！",r.disabled=!0),setTimeout(()=>{Es(),v.classList.remove("modal-in");const p=v.querySelector(".modal-container");p&&p.classList.remove("modal-container-in"),setTimeout(()=>{v.remove(),s(!0)},300)},1200)}else{He();const f=v.querySelector(`.deduction-option[data-answer="${a}"]`);f&&(Ls(f),f.classList.add("wrong")),d.style.display="block",d.className="deduction-feedback feedback-wrong",d.innerHTML="&#x274C; 推理不对，再看看线索，换个答案试试！",i=!1,setTimeout(()=>{f&&f.classList.remove("wrong")},600)}}})}async function Ks(e,t){if((await Ze(e)).filter(v=>v.subjectId==="ot").length>=O.maxCustomTasks){_(`每天最多添加${O.maxCustomTasks}个特别行动`,"warning");return}const s=prompt("特别行动名称:");if(!s||!s.trim())return;const a=prompt("备注（可选）:")||"",i=`ot_${Date.now()}`;if(s.trim(),a.trim(),(await je(i,e,{note:a.trim(),customTitle:s.trim(),customContent:a.trim()})).state.action==="completed"){Ie(),_(`特别行动「${s}」已记录`),G(t,e,!0);const v=document.querySelector("#headerStats");v&&ie(v);const l=document.querySelector("#sideStats");l&&ie(l)}}async function rt(e){if(e)try{Me(e);const t=await de();e.innerHTML="";const n=u("div",{className:"archive-header"}),s=t.reduce((y,b)=>y+(b.stars||0),0),a=[...new Set(t.map(y=>y.date))];n.innerHTML=`
    ...
    `,e.appendChild(v);const l=u("div",{className:"archive-list"});e.appendChild(l),_e(l,t,"","","date-desc");const c=v.querySelector(".archive-search-input"),d=v.querySelector(".archive-filter-select"),r=v.querySelector(".archive-sort-select");c&&c.addEventListener("input",()=>{_e(l,t,c.value,d.value,r.value)}),d&&d.addEventListener("change",()=>{_e(l,t,c.value,d.value,r.value)}),r&&r.addEventListener("change",()=>{_e(l,t,c.value,d.value,r.value)});const f=await Ut(),p=u("div",{className:"archive-section"});if(p.innerHTML='<div class="section-title">&#x1F381; 证物记录</div>',f.length===0){const y=u("div",{className:"achievements-empty"});y.innerHTML="<p>还没有收集到证物，多完成任务来发现线索吧！</p>",p.appendChild(y)}else{const y=u("div",{className:"achievements-grid"});for(const b of f.slice(0,24)){const k=u("div",{className:"achievement-badge"});k.innerHTML=`
        ...
        `,y.appendChild(k)}p.appendChild(y)}e.appendChild(p)}catch(t){console.error("renderTabArchive failed:",t),Be(e,`档案加载失败: ${t.message}`,()=>rt(e))}}function Ct(e){const t=e.taskId;if(t.startsWith("ot_"))return e.customTitle||"特别行动";if(t.startsWith("sp_")){const s=t.replace("sp_",""),a=Lt.find(i=>i.id===s);return a?a.name:t}if(t.startsWith("daily_")){const s=t.split("_");if(s.length>=3){const a=s[1],i=s.slice(2).join("_"),o=qt[a];if(o){const v=o.find(l=>l.id===i);if(v)return v.title}}return t}if(t.startsWith("ch_")){const s=t.split("_");if(s.length>=4){const a=s[1],i=parseInt(s[2],10),o=parseInt(s[3],10),v=st[a];if(v&&v[i]&&v[i].items[o])return v[i].items[o]}return t}const n=ue.find(s=>s.id===t);return n?n.title:e.customTitle||t}function _e(e,t,n="",s="",a="date-desc"){if(!e)return;Ns(e);let i=[...t];if(s&&(i=i.filter(l=>l.subjectId===s)),n){const l=n.toLowerCase();i=i.filter(c=>Ct(c).toLowerCase().includes(l))}if(i.sort((l,c)=>a==="date-asc"?l.date.localeCompare(c.date):a==="stars-desc"&&c.stars-l.stars||c.date.localeCompare(l.date)),i.length===0){Pt(e,"没有找到匹配的记录");return}let o="",v=null;for(const l of i){if(l.date!==o){o=l.date,v=u("div",{className:"archive-date-card"});const p=i.filter(y=>y.date===o).reduce((y,b)=>y+(b.stars||0),0);v.innerHTML=`
      ...
      `,e.appendChild(v)}ue.find(p=>p.id===l.taskId);const c=Je(l.subjectId),d=Ct(l),r=u("div",{className:"archive-item"});r.innerHTML=`
      <div class="archive-item-dot" style="background:${c?c.color:"#94A3B8"};"></div>
      <div class="archive-item-info">
        <div class="archive-item-title">${h(d)}</div>
    ...
    `,r.addEventListener("click",async()=>{if(await It("撤回确认",`确定要撤回「${d}」的打卡记录吗？星星也将被收回。`))try{if((await Ee(l.taskId,l.date)).state.action==="undone"){He(),_(`已撤回「${d}」`);const b=document.querySelector("#tabArchive");b&&rt(b)}}catch(y){_(`撤回失败: ${y.message}`,"error")}});const f=v.querySelector(".archive-date-card-grid");f&&f.appendChild(r)}}async function Vt(e){if(e)try{let $=function(m,g,F){const C=u("div",{className:"cal-split-col"}),L=u("div",{className:"cal-split-header"}),U=F.reduce((w,Y)=>w+Y.stars,0),z=F.filter(w=>w.hasActivity).length;L.textContent=`${g}  ${U}星 ${z}天`,C.appendChild(L);const se=u("div",{className:"cal-split-week"});b.forEach(w=>se.appendChild(u("span",{},w))),C.appendChild(se);let D=u("div",{className:"cal-split-row"});const re=new Date(F[0].date+"T00:00:00").getDay();for(let w=0;w<re;w++)D.appendChild(u("div",{className:"cal-s2-cell cal-s2-empty"}));for(const w of F){if(new Date(w.date+"T00:00:00").getDay()===0&&D.children.length>0){for(;D.children.length<7;)D.appendChild(u("div",{className:"cal-s2-cell cal-s2-empty"}));C.appendChild(D),D=u("div",{className:"cal-split-row"})}const P=["cal-s2-cell"];w.isToday&&P.push("cal-s2-today"),w.isSunday&&P.push("cal-s2-sun"),w.isTravel&&P.push("cal-s2-travel"),w.hasActivity&&P.push("cal-s2-on");const K=u("div",{className:P.join(" "),title:`${oe(w.date)}  ${w.stars}星 ${w.count}项`}),yt=w.date.slice(8).replace(/^0/,""),ht=d[w.date],we=ht?Wt.find(De=>De.id===ht):null;if(w.hasActivity){const De=Math.min(Math.floor(w.stars/8*(k.length-1)),k.length-1),[ns,as,is]=k[De];K.style.background=`rgb(${ns},${as},${is})`,K.style.color=De>=4?"#fff":"#374151"}else w.isSunday?(K.style.background="#F1F5F9",K.style.color="#94A3B8"):w.isTravel?(K.style.background="#FEF9C3",K.style.color="#B45309"):(K.style.background="#F8FAFC",K.style.color="#9CA3AF");K.innerHTML=we?`<span class="cal-date-num">${yt}</span><span class="cal-mood-emoji">${we.icon}</span><span class="cal-mood-label">${we.label}</span>`:`<span class="cal-date-num">${yt}</span>`,K.title=`${oe(w.date)}${w.hasActivity?"  "+w.stars+"星 "+w.count+"项":""}${we?"  "+we.label:""}`,D.appendChild(K)}for(;D.children.length<7;)D.appendChild(u("div",{className:"cal-s2-cell cal-s2-empty"}));return C.appendChild(D),C};var t=$;Me(e);const n=await pe(),s=await Mt(),a=await Le(),i=await ws();e.innerHTML="";const o=u("div",{className:"stats-rank-card"});o.innerHTML=`
    ...
    `,e.appendChild(v);const l=await at(),c=await Ne();if(c.length>0||l.activeCase){const m=u("div",{className:"stats-section"});if(m.innerHTML='<div class="section-title">🕵️‍♂️ 谜案侦破</div>',l.activeCase){const g=l.activeCase,F=Math.round(g.progress*100),C=u("div",{className:"mystery-card mystery-card-active"});C.innerHTML=`
        ...
        `,m.appendChild(C)}if(c.length>0){const g=u("div",{className:"mystery-solved-title"});g.innerHTML=`已侦破案件 (${c.length}/${l.totalCases})`,m.appendChild(g);const F=u("div",{className:"mystery-solved-list"}),C=c.slice(-8).reverse();for(const L of C){const U=u("div",{className:"mystery-solved-item"});U.innerHTML=`
            <span class="mystery-solved-icon">✅</span>
            <span class="mystery-solved-name">${h(L.caseTitle)}</span>
            <span class="mystery-solved-date">${L.solvedAt?L.solvedAt.slice(0,10):""}</span>
          `,F.appendChild(U)}m.appendChild(F)}if(l.allSolved){const g=u("div",{className:"mystery-all-done"});g.innerHTML="🏆 全部案件已侦破！你是真正的传奇侦探！",m.appendChild(g)}e.appendChild(m)}const d=await E("moods")||{},r=u("div",{className:"stats-section"});r.innerHTML='<div class="section-title">&#x1F4C5; 侦探之旅</div>';const f=i.filter(m=>m.hasActivity).length,p=i.reduce((m,g)=>m+g.stars,0),y=u("div",{className:"journey-bar"});y.innerHTML=`
      <span>${i.length}天旅程</span>
      <span class="journey-bar-sep">|</span>
      <span>${f}天打卡</span>
      <span class="journey-bar-sep">|</span>
      <span>${p}星</span>
    `,r.appendChild(y);const b=["日","一","二","三","四","五","六"],k=[[235,250,240],[187,247,208],[134,224,167],[74,200,120],[34,170,80],[139,92,246]],S=i.filter(m=>m.date.startsWith("2026-07")),A=i.filter(m=>m.date.startsWith("2026-08")),j=u("div",{className:"calendar-split"});j.appendChild($("07","七月",S)),j.appendChild($("08","八月",A)),r.appendChild(j);const R=u("div",{className:"cal-split-legend"});R.innerHTML=`
      <span>少</span>
      ...
      <span>多</span>
    `,r.appendChild(R),e.appendChild(r);const T=u("div",{className:"stats-section"});T.innerHTML='<div class="section-title">&#x1F4C6; 每周小结</div>';const N={};for(const m of i){const g=new Date(m.date+"T00:00:00"),F=g.getDay(),C=new Date(g);C.setDate(g.getDate()-(F===0?6:F-1));const L=C.toISOString().slice(0,10);N[L]||(N[L]={start:L,days:[],stars:0,active:0}),N[L].days.push(m),m.hasActivity&&(N[L].stars+=m.stars,N[L].active++)}const x=await E("case_closed")||{},B=await Ne(),be=Object.keys(N).sort().filter(m=>N[m].active>0||N[m].days.some(g=>g.isToday));if(be.length>0){const m=u("div",{className:"week-summary-grid"});for(const g of be.slice(-6)){const F=N[g];if(F.active===0&&!F.days.some(D=>D.isToday))continue;const C=new Date(g);C.setDate(C.getDate()+6);const L=C.toISOString().slice(0,10),U=B.filter(D=>D.solvedAt&&D.solvedAt.slice(0,10)>=g&&D.solvedAt.slice(0,10)<=L).length,z=u("div",{className:"week-card"}),se=F.days.some(D=>D.isToday);z.innerHTML=`
      ...
      `,Oe.appendChild(U)}ge.appendChild(Oe),e.appendChild(ge);const Ce=u("div",{className:"stats-section"});if(Ce.innerHTML='<div class="section-title">&#x1F3C6; 成就徽章</div>',a.length===0){const m=u("div",{className:"achievements-empty"});m.innerHTML="<p>还没有解锁任何成就，继续努力吧！</p>",Ce.appendChild(m)}else{const m=u("div",{className:"achievements-grid"});for(const g of a){const F=u("div",{className:"achievement-badge"});F.innerHTML=`
        ...
        `,m.appendChild(F)}Ce.appendChild(m)}e.appendChild(Ce);const Se=u("div",{className:"stats-section"});Se.innerHTML='<div class="section-title">&#x1F4DD; 探案笔记（学习日记）</div>';const ut=await E("diary")||{},pt=Object.keys(ut).sort().reverse();if(pt.length===0){const m=u("div",{className:"achievements-empty"});m.innerHTML="<p>还没有写过探案笔记，完成一天的所有任务后可以记录心得哦！</p>",Se.appendChild(m)}else{const m=u("div",{className:"diary-list"});for(const g of pt.slice(0,14)){const F=ut[g];if(!F||!F.text)continue;const C=u("div",{className:"diary-item"});C.innerHTML=`
          <div class="diary-item-date">${oe(g)}</div>
          <div class="diary-item-text">${h(F.text)}</div>
          ${F.stars?'<div class="diary-item-stars">&#x2B50; +'+F.stars+"</div>":""}
        `,m.appendChild(C)}Se.appendChild(m)}e.appendChild(Se);const es=u("div",{className:"stats-section"});es.innerHTML='<div class="section-title">&#x1F4C1; 数据管理</div>';const Te=u("div",{className:"backup-actions"});Te.innerHTML=`
    ...
    `;const ts=Te.querySelector(".backup-btn-export"),ss=Te.querySelector(".backup-btn-import"),Re=Te.querySelector("#backupFileInput");ts.addEventListener("click",async()=>{try{const m=await de(),g=await Le(),F=await et(),C=await E("diary")||{},L=await E("blindbox_history")||[],U=await E("case_closed")||{},z={version:1,exportedAt:new Date().toISOString(),progress:m,achievements:g,suggested:F,diary:C,blindboxHistory:L,caseClosed:U},se=JSON.stringify(z,null,2),D=new Blob([se],{type:"application/json"}),re=URL.createObjectURL(D),w=document.createElement("a");w.href=re,w.download=`detective_backup_${W()}.json`,w.click(),URL.revokeObjectURL(re),_("备份文件已下载！","success")}catch(m){_("导出失败: "+m.message,"error")}}),ss.addEventListener("click",()=>{Re.click()}),Re.addEventListener("change",async m=>{const g=m.target.files[0];if(g)try{const F=await g.text(),C=JSON.parse(F);if(!C.version||!C.progress)throw new Error("备份文件格式不正确");if(!await new Promise(w=>{confirm("导入将覆盖当前所有数据，确定继续吗？")?w(!0):w(!1)})){Re.value="";return}const U=ds();if(!U)throw new Error("数据库未初始化");const z=U.transaction(["progress","achievements","suggested","state"],"readwrite"),se=z.objectStore("progress");await new Promise((w,Y)=>{const P=se.clear();P.onsuccess=w,P.onerror=Y});for(const w of C.progress){const{id:Y,...P}=w;se.add(P)}const D=z.objectStore("achievements");await new Promise((w,Y)=>{const P=D.clear();P.onsuccess=w,P.onerror=Y});for(const w of C.achievements||[])D.add(w);const re=z.objectStore("suggested");await new Promise((w,Y)=>{const P=re.clear();P.onsuccess=w,P.onerror=Y});for(const w of C.suggested||[])re.add(w);await new Promise((w,Y)=>{z.oncomplete=w,z.onerror=Y}),C.diary&&await q("diary",C.diary),C.blindboxHistory&&await q("blindbox_history",C.blindboxHistory),C.caseClosed&&await q("case_closed",C.caseClosed),_("数据恢复成功！页面即将刷新...","success"),setTimeout(()=>location.reload(),1500)}catch(F){console.error("Import failed:",F),_("导入失败: "+F.message,"error")}});const Ae=u("div",{className:"stats-section"});Ae.innerHTML='<div class="section-title">&#x1F381; 证据陈列室</div>';const vt=await E("blindbox_history")||[];if(vt.length===0){const m=u("div",{className:"achievements-empty"});m.innerHTML="<p>还没有收集到证物，多完成任务来发现线索吧！</p>",Ae.appendChild(m)}else{const m=u("div",{className:"achievements-grid"});for(const g of vt.slice(0,12)){const F=u("div",{className:"achievement-badge"});F.innerHTML=`
          <div class="achievement-badge-icon">${g.icon||"&#x1F381;"}</div>
          <div class="achievement-badge-title">${h(g.title||"神秘证物")}</div>
          <div class="achievement-badge-desc">${h(g.desc||"")}</div>
        `,m.appendChild(F)}Ae.appendChild(m)}e.appendChild(Ae)}catch(n){console.error("renderTabStats failed:",n),Be(e,`统计加载失败: ${n.message}`,()=>Vt(e))}}function Vs(){const e=ue.filter(n=>n.subject==="en"),t=[];for(const n of e){const s=n.content.split(`
`).filter(Boolean);for(const a of s){const i=a.indexOf(" ");if(i<0)continue;const o=a.slice(0,i).trim(),v=a.slice(i+1).trim();o&&v&&t.push({id:`${n.id}_${t.length}`,word:o,meaning:v,unitId:n.id,unitTitle:n.title,category:n.category||""})}}return t}function Js(){const e=Vs(),t=new Map;for(const n of e)t.has(n.unitId)||t.set(n.unitId,{unitId:n.unitId,unitTitle:n.unitTitle,category:n.category,words:[]}),t.get(n.unitId).words.push(n);return[...t.values()]}let he=0,Z=0,xe=!1,St=0,Tt=0,ne=!0,J=[];async function Jt(e){if(e)try{Me(e);const t=Js();if(t.length===0){Pt(e,"还没有英文单词数据");return}J=await E("mastered_words")||[];const n=new Set(J);e.innerHTML="";const s=u("div",{className:"word-toolbar"}),a=u("select",{className:"word-select"});t.forEach((c,d)=>{const r=document.createElement("option");r.value=d;const f=c.words.filter(p=>n.has(p.id)).length;r.textContent=`${c.unitTitle} (${f}/${c.words.length})`,d===he&&(r.selected=!0),a.appendChild(r)}),a.addEventListener("change",()=>{he=parseInt(a.value),Z=Ke(t,0),xe=!1,ve(e,t)}),s.appendChild(a);const i=u("button",{className:`word-filter-btn ${ne?"active":""}`,onClick:()=>{ne=!ne,i.classList.toggle("active",ne),i.textContent=ne?"未掌握":"全部",Z=ne?Ke(t,0):0,ve(e,t)}},ne?"未掌握":"全部");s.appendChild(i),e.appendChild(s);const o=u("div",{className:"word-card-area",id:"wordCardArea"});e.appendChild(o);const v=u("div",{className:"word-actions",id:"wordActions"});e.appendChild(v);const l=u("div",{className:"word-nav"});e.appendChild(l),ne&&(Z=Ke(t,0)),ve(e,t)}catch(t){console.error("renderTabWords failed:",t),Be(e,`加载失败: ${t.message}`,()=>Jt(e))}}function Ke(e,t){const n=e[he];if(!n)return t;const s=new Set(J);for(let a=t;a<n.words.length;a++)if(!s.has(n.words[a].id))return a;return t}function lt(e){if(!e)return[];if(!ne)return e.words;const t=new Set(J);return e.words.filter(n=>!t.has(n.id))}async function ve(e,t){const n=t[he];if(!n||n.words.length===0)return;const s=lt(n);if(s.length===0){const d=e.querySelector("#wordCardArea");d&&(d.innerHTML='<div class="word-all-mastered">🎉 本单元单词已全部掌握！</div>');const r=e.querySelector(".word-nav");r&&(r.innerHTML="");const f=e.querySelector("#wordActions");f&&(f.innerHTML="");return}Z>=s.length&&(Z=0);const a=s[Z];if(!a)return;const i=e.querySelector("#wordCardArea"),o=e.querySelector(".word-nav"),v=e.querySelector("#wordActions");if(!i||!o||!v)return;const l=J.includes(a.id);xe=!1,i.innerHTML=`
  ...
  `;const c=i.querySelector("#wordCard");c&&(c.addEventListener("click",()=>{xe=!xe,c.querySelector(".word-card").classList.toggle("flipped",xe)}),c.addEventListener("touchstart",d=>{St=d.touches[0].clientX,Tt=d.touches[0].clientY},{passive:!0}),c.addEventListener("touchend",d=>{const r=d.changedTouches[0].clientX-St,f=d.changedTouches[0].clientY-Tt;Math.abs(r)>50&&Math.abs(r)>Math.abs(f)&&(r<0?Ve(e,t):At(e,t))})),v.innerHTML=`
    <button class="word-action-btn word-action-know" id="wordKnow">
      ${l?"✅ 已掌握":"💡 我会了"}
    </button>
  `,v.querySelector("#wordKnow").addEventListener("click",async()=>{l?(J=J.filter(r=>r!==a.id),_("已取消标记")):(J.push(a.id),_("已标记为掌握")),await q("mastered_words",J);const d=e.querySelector(".word-select");if(d){const r=new Set(J);Array.from(d.options).forEach((f,p)=>{if(t[p]){const y=t[p].words.filter(b=>r.has(b.id)).length;f.textContent=`${t[p].unitTitle} (${y}/${t[p].words.length})`}})}ne&&J.includes(a.id)?Ve(e,t):ve(e,t)}),o.innerHTML=`
  ...
  `,o.querySelector("#wordPrev").addEventListener("click",()=>At(e,t)),o.querySelector("#wordNext").addEventListener("click",()=>Ve(e,t))}function At(e,t){const n=t[he],s=lt(n);s.length!==0&&(Z=(Z-1+s.length)%s.length,ve(e,t))}function Ve(e,t){const n=t[he],s=lt(n);s.length!==0&&(Z=(Z+1)%s.length,ve(e,t))}let ye="search",Dt=!1;function Qs(){const e=M("#app");if(!e){console.error("FATAL: #app element not found"),document.body.innerHTML='<div style="padding:40px;text-align:center;color:red;">应用初始化失败：找不到根元素 #app</div>';return}e.innerHTML=`
    <!-- 顶部导航栏（桌面端深色 + 移动端浅色） -->
    <header id="topBar">
  ...
  `}function Zs(e){if(ye===e)return;ye=e,ze(".tab-btn").forEach(a=>{a.classList.toggle("active",a.dataset.tab===e)}),ze(".side-nav-btn").forEach(a=>{a.classList.toggle("active",a.dataset.tab===e)}),ze(".tab-content").forEach(a=>{a.classList.toggle("active",a.id===`tab${Qt(e)}`)}),Zt()}function Qt(e){return e.charAt(0).toUpperCase()+e.slice(1)}async function Zt(){try{const e=Ot();switch(ye){case"search":{const t=M("#tabSearch");t&&await G(t,e);break}case"archive":{const t=M("#tabArchive");t&&await rt(t);break}case"stats":{const t=M("#tabStats");t&&await Vt(t);break}case"words":{const t=M("#tabWords");t&&await Jt(t);break}}}catch(e){console.error(`Failed to render tab ${ye}:`,e);const t=M(`#tab${Qt(ye)}`);t&&(t.innerHTML=`
        <div class="error-container">
          <div class="error-icon">&#x1F50D;</div>
          <p class="error-text">页面渲染失败: ${e.message}</p>
          <button class="btn btn-primary" onclick="location.reload()">刷新页面</button>
        </div>
      `)}}function en(){const e=s=>{const a=s.target.closest(".tab-btn, .side-nav-btn");if(!a)return;const i=a.dataset.tab;i&&Zs(i)},t=M("#tabNav");t&&t.addEventListener("click",e);const n=M("#sideNav");n&&n.addEventListener("click",e),document.addEventListener("click",()=>{Rs()},{once:!0}),document.addEventListener("keydown",s=>{var a,i;if(ye==="search"){if(s.key==="ArrowLeft"){s.preventDefault();const o=(a=M("#dateNav"))==null?void 0:a.querySelector(".date-nav-prev");o&&!o.disabled&&o.click()}else if(s.key==="ArrowRight"){s.preventDefault();const o=(i=M("#dateNav"))==null?void 0:i.querySelector(".date-nav-next");o&&!o.disabled&&o.click()}}})}async function _t(){try{console.log("[App] Starting initialization..."),Qs(),console.log("[App] Skeleton rendered"),en(),console.log("[App] Events bound");try{await rs(),Dt=!0,console.log("[App] Database opened")}catch(e){console.error("[App] Database open failed:",e),_("数据库初始化失败，部分功能不可用","error",4e3)}if(Dt)try{await gs(),console.log("[App] Suggested dates assigned")}catch(e){console.warn("[App] Suggested dates assignment failed:",e)}await sn(),console.log("[App] Initialization complete")}catch(e){console.error("[App] Fatal initialization error:",e);const t=M("#app");t&&(t.innerHTML=`
      ...
      `)}}async function tn(){try{const e=M("#sideStats");if(e)try{await ie(e)}catch{}const t=M("#sideMystery");if(t)try{const n=await at();if(n.allSolved)t.innerHTML='<div class="side-mystery side-mystery-done">🏆 全部案件已侦破！</div>';else if(n.activeCase){const s=n.activeCase,a=Math.round(s.progress*100);t.innerHTML=`
            ...
            </div>`}}catch{t.innerHTML=""}}catch(e){console.error("[App] Sidebar render failed:",e)}}async function sn(){try{await tn();const e=M("#headerStats");if(e)try{await ie(e)}catch(n){console.error("[App] Header stats render failed:",n),e.innerHTML='<div class="header-stats-error">统计加载失败</div>'}const t=M("#dateNav");if(t)try{Ms(t,async n=>{try{const s=M("#tabSearch");s&&await G(s,n);const a=M("#headerStats");if(a)try{await ie(a)}catch{}const i=M("#sideStats");if(i)try{await ie(i)}catch{}}catch(s){console.error("[App] Date change render failed:",s)}})}catch(n){console.error("[App] Date nav render failed:",n)}await Zt()}catch(e){console.error("[App] Render failed:",e),_("页面渲染失败，请刷新重试","error",4e3)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_t):_t();
